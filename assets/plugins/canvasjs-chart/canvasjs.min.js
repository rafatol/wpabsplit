/*
 CanvasJS Chart - v3.7.22 GA - https://canvasjs.com/ 
...
[],b,e=0;e<a.length;e++)if(0==e)c.push(a[0]);else{var g,l,t;t=e-1;g=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[g].x)/(0===a[l].x-a[t].x?0.01:a[l].x-a[t].x))*(d-1)/2+1;var D=(a[l].x-a[g].x)/b;b=(a[l].y-a[g].y)/b;c[c.length]=a[t].x>a[g].x&&0<D||a[t].x<a[g].x&&0>D?{x:a[t].x+D/3,y:a[t].y+b/3}:{x:a[t].x,y:a[t].y+b/9};t=e;g=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[g].x)/(0===a[t].x-a[g].x?0.01:a[t].x-a[g].x))*(d-1)/2+1;D=(a[l].x-a[g].x)/b;b=(a[l].y-a[g].y)/b;c[c.length]=a[t].x>
a[g].x&&0<D||a[t].x<a[g].x&&0>D?{x:a[t].x-D/3,y:a[t].y-b/3}:{x:a[t].x,y:a[t].y-b/9};c[c.length]=a[e]}return c}function B(a,d,c,b,e,g,l,t,D,k){var m=0;k?(l.color=g,t.color=g):k=1;m=D?Math.abs(e-c):Math.abs(b-d);m=0<l.trimLength?Math.abs(m*l.trimLength/100):Math.abs(m-l.length);D?(c+=m/2,e-=m/2):(d+=m/2,b-=m/2);var m=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(t.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=t.color||g;a.lineWidth=t.thickness||2;a.setLineDash&&a.setLineDash(J(t.dashType,
t.thickness));a.beginPath();D&&0<t.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<t.thickness&&(a.moveTo(Math.round((d+b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||g;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(J(l.dashType,l.thickness));a.beginPath();D&&0<l.thickness?(a.moveTo(b-m,c),a.lineTo(b-m,e),a.moveTo(d+m,c),a.lineTo(d+m,e)):0<l.thickness&&(a.moveTo(d,c+
...
[];this.axisY=this.axisX=null;this.optionsName="data";this.isOptionsInArray=!0;null===this.fillOpacity&&(this.type.match(/area/i)?this.fillOpacity=0.7:this.fillOpacity=1);this.axisPlacement=this.getDefaultAxisPlacement();"undefined"===typeof this.options.indexLabelFontSize&&(this.indexLabelFontSize=this.chart.getAutoFontSize(this.indexLabelFontSize))}function A(a,d,c,b,e,g){A.base.constructor.call(this,"Axis",d,c,b,a);this.chart=a;this.canvas=a.canvas;this.ctx=a.ctx;this.intervalStartPosition=this.maxHeight=
...
this._appliedBreaks.splice(a,2),a--)}}function aa(a,d,c,b,e,g){aa.base.constructor.call(this,"Break",d,c,b,g);this.id=e;this.chart=a;this.ctx=this.chart.ctx;this.scaleBreaks=g;this.optionsName=d;this.isOptionsInArray=!0;this.type=c.type?this.type:g.type;this.fillOpacity=r(c.fillOpacity)?g.fillOpacity:this.fillOpacity;this.lineThickness=r(c.lineThickness)?g.lineThickness:this.lineThickness;this.color=c.color?this.color:g.color;this.lineColor=c.lineColor?this.lineColor:g.lineColor;this.lineDashType=
...
0,0,this.width,this.height),this._preRenderCtx.drawImage(this._breaksCanvas,0,0,this.width,this.height),this._breaksCanvasCtx.globalCompositeOperation="source-atop",this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),this._preRenderCtx.clearRect(0,0,this.width,this.height));for(d=0;d<this.plotInfo.plotTypes.length;d++)for(var g=this.plotInfo.plotTypes[d],l=0;l<g.plotUnits.length;l++){var t=g.plotUnits[l],D=null;t.targetCanvas&&ya(t.targetCanvas);t.targetCanvas=null;this.animatedRender&&
...
m.plotInfo.plotTypes[a],d=0;d<e.plotUnits.length;d++){var g=e.plotUnits[d];g.targetCanvas&&ya(g.targetCanvas);g.targetCanvas=null}b=null;m.disableToolTip=!1;m.dispatchEvent("dataAnimationEnd",{chart:m})});else{if(m._breaksCanvas)if(w)m.plotArea.ctx.drawImage(m._breaksCanvas,0,0,this.width,this.height);else for(k=0;k<m._axes.length;k++)m._axes[k].createMask();0<m._indexLabels.length&&m.renderIndexLabels();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});m.dispatchEvent("dataAnimationEnd",{chart:m})}this.attachPlotAreaEventHandlers();
...
"",d=0;d<this.data.length;d++)if(a=this.data[d],a.dataPoints&&(0!==a.dataPoints.length&&a.visible)&&0<=n._supportedChartTypes.indexOf(a.type)){for(var c=null,b=!1,e=null,g=!1,l=0;l<this.plotInfo.plotTypes.length;l++)if(this.plotInfo.plotTypes[l].type===a.type){b=!0;c=this.plotInfo.plotTypes[l];break}b||(c={type:a.type,totalDataSeries:0,plotUnits:[]},this.plotInfo.plotTypes.push(c));for(l=0;l<c.plotUnits.length;l++)if(c.plotUnits[l].axisYType===a.axisYType&&c.plotUnits[l].axisXType===a.axisXType&&
c.plotUnits[l].axisYIndex===a.axisYIndex&&c.plotUnits[l].axisXIndex===a.axisXIndex){g=!0;e=c.plotUnits[l];break}g||(e={type:a.type,previousDataSeriesCount:0,index:c.plotUnits.length,plotType:c,axisXType:a.axisXType,axisYType:a.axisYType,axisYIndex:a.axisYIndex,axisXIndex:a.axisXIndex,axisY:"primary"===a.axisYType?this.axisY[0<=a.axisYIndex&&a.axisYIndex<this.axisY.length?a.axisYIndex:0]:this.axisY2[0<=a.axisYIndex&&a.axisYIndex<this.axisY2.length?a.axisYIndex:0],axisX:"primary"===a.axisXType?this.axisX[0<=
...
typeof t.dataPoints[D].x&&(t.dataPoints[D].x=D+(a.axisX.logarithmic?1:0));t.dataPoints[D].x.getTime?(g=!0,b=t.dataPoints[D].x.getTime()):b=t.dataPoints[D].x;e=t.dataPoints[D].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);e<d.min&&"number"===typeof e&&(d.min=e);e>d.max&&"number"===typeof e&&(d.max=e);if(0<D){if(a.axisX.logarithmic){var s=b/t.dataPoints[D-1].x;1>s&&(s=1/s);c.minDiff>s&&1!==s&&(c.minDiff=s)}else s=b-t.dataPoints[D-1].x,0>s&&(s*=-1),c.minDiff>s&&0!==s&&(c.minDiff=s);null!==e&&null!==t.dataPoints[D-
1].y&&(a.axisY.logarithmic?(s=e/t.dataPoints[D-1].y,1>s&&(s=1/s),d.minDiff>s&&1!==s&&(d.minDiff=s)):(s=e-t.dataPoints[D-1].y,0>s&&(s*=-1),d.minDiff>s&&0!==s&&(d.minDiff=s)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<D)){D-=2;continue}if(b>f&&!m)m=!0;else if(b>f&&m)continue;t.dataPoints[D].label&&(a.axisX.labels[b]=t.dataPoints[D].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&
(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}t.axisX.valueType=t.xValueType=g?"dateTime":"number"}};n.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,g=!1,l=[],t=[],D=Infinity,k=-Infinity,m=0;m<a.dataSeriesIndexes.length;m++){var p=this.data[a.dataSeriesIndexes[m]],q=0,f=!1,s=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var ba=a.axisX.sessionVariables.newViewportMinimum?
...
p.xValueType)g=!0;for(q=0;q<p.dataPoints.length;q++){"undefined"===typeof p.dataPoints[q].x&&(p.dataPoints[q].x=q+(a.axisX.logarithmic?1:0));p.dataPoints[q].x.getTime?(g=!0,b=p.dataPoints[q].x.getTime()):b=p.dataPoints[q].x;e=r(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var y=b/p.dataPoints[q-1].x;1>y&&(y=1/y);c.minDiff>y&&1!==y&&(c.minDiff=y)}else y=b-p.dataPoints[q-1].x,0>y&&(y*=-1),c.minDiff>y&&0!==y&&(c.minDiff=y);null!==e&&null!==
p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(y=e/p.dataPoints[q-1].y,1>y&&(y=1/y),d.minDiff>y&&1!==y&&(d.minDiff=y)):(y=e-p.dataPoints[q-1].y,0>y&&(y*=-1),d.minDiff>y&&0!==y&&(d.minDiff=y)))}if(b<ba&&!f)null!==p.dataPoints[q].y&&(h=b);else{if(!f&&(f=!0,0<q)){q-=2;continue}if(b>u&&!s)s=!0;else if(b>u&&s)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=
...
t));p.axisX.valueType=p.xValueType=g?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,D)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,D)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in t)t.hasOwnProperty(q)&&!isNaN(q)&&(a=t[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,k))))}};n.prototype._processStacked100PlotUnit=
function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,g=!1,l=!1,t=!1,D=[],k=0;k<a.dataSeriesIndexes.length;k++){var m=this.data[a.dataSeriesIndexes[k]],p=0,q=!1,f=!1,s;if("normal"===m.axisPlacement||"xySwapped"===m.axisPlacement)var h=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?
a.axisX.options.minimum:-Infinity,ba=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:a.axisX.options&&a.axisX.options.viewportMaximum?a.axisX.options.viewportMaximum:a.axisX.options&&a.axisX.options.maximum?a.axisX.options.maximum:Infinity;if(m.dataPoints[p].x&&m.dataPoints[p].x.getTime||"dateTime"===m.xValueType)g=!0;for(p=0;p<m.dataPoints.length;p++){"undefined"===typeof m.dataPoints[p].x&&(m.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));m.dataPoints[p].x.getTime?
(g=!0,b=m.dataPoints[p].x.getTime()):b=m.dataPoints[p].x;e=r(m.dataPoints[p].y)?null:m.dataPoints[p].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<p){if(a.axisX.logarithmic){var u=b/m.dataPoints[p-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-m.dataPoints[p-1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u);r(e)||null===m.dataPoints[p-1].y||(a.axisY.logarithmic?0<e&&(u=e/m.dataPoints[p-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-m.dataPoints[p-1].y,0>u&&(u*=-1),d.minDiff>
u&&0!==u&&(d.minDiff=u)))}if(b<h&&!q)null!==e&&(s=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>ba&&!f)f=!0;else if(b>ba&&f)continue;m.dataPoints[p].label&&(a.axisX.labels[b]=m.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&s<b&&(c.viewPortMin=s):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),D[b]=D[b]?D[b]+Math.abs(e):Math.abs(e))}}m.axisX.valueType=
...
-1),d.min=r(d.viewPortMin)?-99:Math.min(d.viewPortMin,-99));d.viewPortMin=d.min;d.viewPortMax=d.max;a.dataPointYSums=D}};n.prototype._processMultiYPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,g,l,t=!1,D=0;D<a.dataSeriesIndexes.length;D++){var k=this.data[a.dataSeriesIndexes[D]],m=0,p=!1,q=!1,f,s,h;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var r=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:
...
for(m=0;m<k.dataPoints.length;m++){"undefined"===typeof k.dataPoints[m].x&&(k.dataPoints[m].x=m+(a.axisX.logarithmic?1:0));k.dataPoints[m].x.getTime?(t=!0,b=k.dataPoints[m].x.getTime()):b=k.dataPoints[m].x;if((e=k.dataPoints[m].y)&&e.length){g=Math.min.apply(null,e);l=Math.max.apply(null,e);s=!0;for(var y=0;y<e.length;y++)null===e.k&&(s=!1);s&&(p||(h=f),f=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);g<d.min&&(d.min=g);l>d.max&&(d.max=l);0<m&&(a.axisX.logarithmic?(s=b/k.dataPoints[m-1].x,1>s&&(s=1/s),
c.minDiff>s&&1!==s&&(c.minDiff=s)):(s=b-k.dataPoints[m-1].x,0>s&&(s*=-1),c.minDiff>s&&0!==s&&(c.minDiff=s)),e&&(null!==e[0]&&k.dataPoints[m-1].y&&null!==k.dataPoints[m-1].y[0])&&(a.axisY.logarithmic?(s=e[0]/k.dataPoints[m-1].y[0],1>s&&(s=1/s),d.minDiff>s&&1!==s&&(d.minDiff=s)):(s=e[0]-k.dataPoints[m-1].y[0],0>s&&(s*=-1),d.minDiff>s&&0!==s&&(d.minDiff=s))));if(!(b<r)||p){if(!p&&(p=!0,0<m)){m-=2;f=h;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[m].label&&(a.axisX.labels[b]=k.dataPoints[m].label);
b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(y=0;y<e.length;y++)if(null===e[y]&&f<b){c.viewPortMin=f;break}null===e?c.viewPortMin===b&&f<b&&(c.viewPortMin=f):(g<d.viewPortMin&&(d.viewPortMin=g),l>d.viewPortMax&&(d.viewPortMax=l))}}k.axisX.valueType=k.xValueType=t?"dateTime":"number"}};n.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,
b,e,g=!1,l=0;l<a.dataSeriesIndexes.length;l++){var t=this.data[a.dataSeriesIndexes[l]],D=0,k=!1,m=!1,p=b=0;if("normal"===t.axisPlacement||"xySwapped"===t.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?a.axisX.options.minimum:a.axisX.logarithmic?0:-Infinity,f=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:
...
0===D?e:t.dataPointEOs[D-1].cumulativeSum+e,b+=e);for(D=0;D<t.dataPoints.length;D++)if("undefined"===typeof t.dataPoints[D].x&&(t.dataPoints[D].x=D+(a.axisX.logarithmic?1:0)),t.dataPoints[D].x.getTime?(g=!0,b=t.dataPoints[D].x.getTime()):b=t.dataPoints[D].x,e=t.dataPoints[D].y,b<c.min&&(c.min=b),b>c.max&&(c.max=b),t.dataPointEOs[D].cumulativeSum<d.min&&(d.min=t.dataPointEOs[D].cumulativeSum),t.dataPointEOs[D].cumulativeSum>d.max&&(d.max=t.dataPointEOs[D].cumulativeSum),0<D&&(a.axisX.logarithmic?(p=
b/t.dataPoints[D-1].x,1>p&&(p=1/p),c.minDiff>p&&1!==p&&(c.minDiff=p)):(p=b-t.dataPoints[D-1].x,0>p&&(p*=-1),c.minDiff>p&&0!==p&&(c.minDiff=p)),null!==e&&null!==t.dataPoints[D-1].y&&(a.axisY.logarithmic?(e=t.dataPointEOs[D].cumulativeSum/t.dataPointEOs[D-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=t.dataPointEOs[D].cumulativeSum-t.dataPointEOs[D-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<D)){D-=2;continue}if(b>f&&!m)m=!0;else if(b>
...
m.dataPoints[k].x.getTime():m.dataPoints[k].x,g=Math.floor((b-c)/g),b<f[g].min&&(f[g].min=b),b>f[g].max&&(f[g].max=b)}}for(var b,e=this,g=!1,l=0;l<this._axes.length;l++)if(this._axes[l].scaleBreaks&&this._axes[l].scaleBreaks.autoCalculate&&1<=this._axes[l].scaleBreaks.maxNumberOfAutoBreaks){g=!0;this._axes[l].dataInfo._dataRanges=[];for(var t=0;t<100/Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10);t++)this._axes[l].dataInfo._dataRanges.push({min:Infinity,max:-Infinity})}if(g){for(l=
0;l<this.plotInfo.plotTypes.length;l++)for(g=this.plotInfo.plotTypes[l],t=0;t<g.plotUnits.length;t++)b=g.plotUnits[t],"line"===b.type||"stepLine"===b.type||"spline"===b.type||"column"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"bar"===b.type||"bubble"===b.type||"scatter"===b.type||"candlestick"===b.type||"ohlc"===b.type||"rangeColumn"===b.type||"rangeBar"===b.type||"rangeArea"===b.type||"rangeSplineArea"===b.type||"waterfall"===b.type||"error"===b.type||"boxAndWhisker"===
b.type?d(b):0<=b.type.indexOf("stacked")&&c(b);for(l=0;l<this._axes.length;l++)if(this._axes[l].dataInfo._dataRanges){var D=this._axes[l].dataInfo.min;b=(this._axes[l].dataInfo.max+1-D)*Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10)/100;var k=this._axes[l].dataInfo._dataRanges,m,p,g=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;m=k;for(t in q)if(q.hasOwnProperty(t)&&!isNaN(t)&&(p=q[t],!r(p))){var f=Math.floor((p-
D)/b);p<m[f].min&&(m[f].min=p);p>m[f].max&&(m[f].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=this._axes[l].dataInfo.dataPointYNegativeSums;m=k;for(t in q)q.hasOwnProperty(t)&&!isNaN(t)&&(p=-1*q[t],r(p)||(f=Math.floor((p-D)/b),p<m[f].min&&(m[f].min=p),p>m[f].max&&(m[f].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(t=0;t<k.length-1;t++)if(m=k[t].max,isFinite(m))for(;t<k.length-1;)if(D=k[t+1].min,isFinite(D)){p=D-
m;p>b&&g.push({diff:p,start:m,end:D});break}else t++;if(this._axes[l].scaleBreaks.customBreaks)for(t=0;t<this._axes[l].scaleBreaks.customBreaks.length;t++)for(b=0;b<g.length;b++)if(this._axes[l].scaleBreaks.customBreaks[t].startValue<=g[b].start&&g[b].start<=this._axes[l].scaleBreaks.customBreaks[t].endValue||this._axes[l].scaleBreaks.customBreaks[t].startValue<=g[b].start&&g[b].start<=this._axes[l].scaleBreaks.customBreaks[t].endValue||g[b].start<=this._axes[l].scaleBreaks.customBreaks[t].startValue&&
this._axes[l].scaleBreaks.customBreaks[t].startValue<=g[b].end||g[b].start<=this._axes[l].scaleBreaks.customBreaks[t].endValue&&this._axes[l].scaleBreaks.customBreaks[t].endValue<=g[b].end)g.splice(b,1),b--;g.sort(function(a,b){return b.diff-a.diff});for(t=0;t<Math.min(g.length,this._axes[l].scaleBreaks.maxNumberOfAutoBreaks);t++)b=a(g[t].start,g[t].end,this._axes[l].logarithmic?this._axes[l].dataInfo.max/this._axes[l].dataInfo.min:this._axes[l].dataInfo.max-this._axes[l].dataInfo.min,this._axes[l].logarithmic),
...
for(d=0;d<this.axisY2.length;d++)this.axisY2[d]!=a&&(this.axisY2[d].crosshair&&this.axisY2[d].crosshair.enabled&&!this.axisY2[d].crosshair._hidden)&&this.axisY2[d].showCrosshair(this.axisY2[d].crosshair._updatedValue)};n.prototype.getDataPointAtXY=function(a,d,c){c=c||!1;for(var b=[],e=this._dataInRenderedOrder.length-1;0<=e;e--){var g=null;(g=this._dataInRenderedOrder[e].getDataPointAtXY(a,d,c))&&b.push(g)}a=null;d=!1;for(c=0;c<b.length;c++)if("line"===b[c].dataSeries.type||"stepLine"===b[c].dataSeries.type||
...
1<c.length)){e=Pa(b);e.time=new Date;try{var l=e.y-this._lastTouchData.y,g=e.time-this._lastTouchData.time;if(1<Math.abs(l)&&this._lastTouchData.scroll||5<Math.abs(l)&&250>g)this._lastTouchData.scroll=!0}catch(t){}this._lastTouchEventType=a.type;if(this._lastTouchData.scroll&&this.zoomEnabled)this.isDrag&&this.resetOverlayedCanvas(),this.isDrag=!1;else for(c=0;c<d.length;c++)if(e=d[c],l=document.createEvent("MouseEvent"),l.initMouseEvent(e,!0,!0,window,1,b.screenX,b.screenY,b.clientX,b.clientY,!1,
!1,!1,!1,0,null),b.target.dispatchEvent(l),!r(this._lastTouchData.scroll)&&!this._lastTouchData.scroll||!this._lastTouchData.scroll&&250<g||"click"===e)a.preventManipulation&&a.preventManipulation(),a.preventDefault&&a.cancelable&&a.preventDefault()}}};n.prototype._dispatchRangeEvent=function(a,d){var c={chart:this};c.type=a;c.trigger=d;var b=[];this.axisX&&0<this.axisX.length&&b.push("axisX");this.axisX2&&0<this.axisX2.length&&b.push("axisX2");this.axisY&&0<this.axisY.length&&b.push("axisY");this.axisY2&&
...
this.axisY2[g].crosshair.enabled&&(this.axisY2[g].crosshair.hide(),this.axisY2[g].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisY2[g].options},this.axisY2[g].crosshair))}this.isDrag&&this.zoomEnabled||!this._eventManager||this._eventManager.mouseEventHandler(a)}};n.prototype._plotAreaMouseDown=function(a,d){this.isDrag=!0;this.dragStartPoint={x:a,y:d}};n.prototype._plotAreaMouseUp=function(a,d){if(("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)&&this.isDrag){var c=
d-this.dragStartPoint.y,b=a-this.dragStartPoint.x,e=0<=this.zoomType.indexOf("x"),g=0<=this.zoomType.indexOf("y"),l=!1;this.resetOverlayedCanvas();if("xySwapped"===this.plotInfo.axisPlacement)var t=g,g=e,e=t;if(this.panEnabled||this.zoomEnabled){if(this.panEnabled)for(e=g=0;e<this._axes.length;e++)c=this._axes[e],c.logarithmic?c.viewportMinimum<c.minimum?(g=c.minimum/c.viewportMinimum,c.sessionVariables.newViewportMinimum=c.viewportMinimum*g,c.sessionVariables.newViewportMaximum=c.viewportMaximum*
g,l=!0):c.viewportMaximum>c.maximum&&(g=c.viewportMaximum/c.maximum,c.sessionVariables.newViewportMinimum=c.viewportMinimum/g,c.sessionVariables.newViewportMaximum=c.viewportMaximum/g,l=!0):c.viewportMinimum<c.minimum?(g=c.minimum-c.viewportMinimum,c.sessionVariables.newViewportMinimum=c.viewportMinimum+g,c.sessionVariables.newViewportMaximum=c.viewportMaximum+g,l=!0):c.viewportMaximum>c.maximum&&(g=c.viewportMaximum-c.maximum,c.sessionVariables.newViewportMinimum=c.viewportMinimum-g,c.sessionVariables.newViewportMaximum=
c.viewportMaximum-g,l=!0);else if((!e||2<Math.abs(b))&&(!g||2<Math.abs(c))&&this.zoomEnabled){if(!this.dragStartPoint)return;c=e?this.dragStartPoint.x:this.plotArea.x1;b=g?this.dragStartPoint.y:this.plotArea.y1;e=e?a:this.plotArea.x2;g=g?d:this.plotArea.y2;2<Math.abs(c-e)&&2<Math.abs(b-g)&&this._zoomPanToSelectedRegion(c,b,e,g)&&(l=!0)}l&&(this._ignoreNextEvent=!0,this._dispatchRangeEvent("rangeChanging","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter||
...
source:"chart",index:this.stockChart.charts.indexOf(this),minimum:e.val1,maximum:e.val2});return a.isValid};n.prototype.validateRegion=function(a,d,c,b,e){e=e||!1;for(var g=0<=this.zoomType.indexOf("x"),l=0<=this.zoomType.indexOf("y"),t=!1,D=[],k=[],m=[],p=0;p<this._axes.length;p++)("axisX"===this._axes[p].type&&g||"axisY"===this._axes[p].type&&l)&&k.push(this._axes[p]);for(l=0;l<k.length;l++){var p=k[l],g=!1,q=p.convertPixelToValue({x:a,y:d}),f=p.convertPixelToValue({x:c,y:b});if(q>f)var s=f,f=q,
q=s;if(p.scaleBreaks)for(s=0;!g&&s<p.scaleBreaks._appliedBreaks.length;s++)g=p.scaleBreaks._appliedBreaks[s].startValue<=q&&p.scaleBreaks._appliedBreaks[s].endValue>=f;if(isFinite(p.dataInfo.minDiff))if(s=p.getApparentDifference(q,f,null,!0),!(g||!(this.panEnabled&&p.scaleBreaks&&p.scaleBreaks._appliedBreaks.length)&&(p.logarithmic&&s<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&s<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||f>p.maximum))D.push(p),m.push({val1:q,val2:f}),t=!0;else if(!e){t=!1;
...
a.height=d.height;w||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Fa(a.x1,a.y1,a.x2,a.y2,2)};n.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,g=0,l=g=e=0,t=0,D=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var m=this._indexLabels[a],p=m.chartType.toLowerCase(),q,f,l=ma("indexLabelFontColor",m.dataPoint,m.dataSeries),s=ma("indexLabelFontSize",
m.dataPoint,m.dataSeries),t=ma("indexLabelFontFamily",m.dataPoint,m.dataSeries),D=ma("indexLabelFontStyle",m.dataPoint,m.dataSeries),k=ma("indexLabelFontWeight",m.dataPoint,m.dataSeries),h=ma("indexLabelBackgroundColor",m.dataPoint,m.dataSeries);q=ma("indexLabelMaxWidth",m.dataPoint,m.dataSeries);f=ma("indexLabelWrap",m.dataPoint,m.dataSeries);var ba=ma("indexLabelLineDashType",m.dataPoint,m.dataSeries),u=ma("indexLabelLineColor",m.dataPoint,m.dataSeries),n=r(m.dataPoint.indexLabelLineThickness)?
...
H&&""!==H){var x=ma("indexLabelPlacement",m.dataPoint,m.dataSeries),z=ma("indexLabelOrientation",m.dataPoint,m.dataSeries),C=ma("indexLabelTextAlign",m.dataPoint,m.dataSeries),v=m.direction,e=m.dataSeries.axisX,g=m.dataSeries.axisY,A=!1,h=new ja(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:f?5*s:1.5*s,angle:"horizontal"===z?0:-90,text:H,padding:0,backgroundColor:h,textAlign:C,fontSize:s,fontFamily:t,fontWeight:k,fontColor:l,fontStyle:D,textBaseline:"middle"});h.measureText();m.dataSeries.indexLabelMaxWidth=
h.maxWidth;if("stackedarea100"===p){if(m.point.x<c.x1||m.point.x>c.x2||m.point.y<c.y1-1||m.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<g.viewportMinimum||Math.min.apply(null,m.dataPoint.y)>g.viewportMaximum)continue}else if(0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("bubble")||0<=p.indexOf("scatter")){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||
m.dataPoint.y<g.viewportMinimum||m.dataPoint.y>g.viewportMaximum)continue}else if(0<=p.indexOf("column")||"waterfall"===p||"error"===p&&!m.axisSwapped){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||m.bounds.y1>c.y2||m.bounds.y2<c.y1)continue}else if(0<=p.indexOf("bar")||"error"===p){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||m.bounds.x1>c.x2||m.bounds.x2<c.x1)continue}else if("candlestick"===p||"ohlc"===p){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>
e.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<g.viewportMinimum||Math.min.apply(null,m.dataPoint.y)>g.viewportMaximum)continue}else if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum)continue;l=t=2;"horizontal"===z?(D=h.width,k=h.height):(k=h.width,D=h.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))x="auto",t=4;else if(0<=p.indexOf("stacked"))"auto"===x&&(x="inside");else if("bubble"===p||"scatter"===p)x="inside";q=m.point.x-
("horizontal"===z?D/2:D/2-s/2);"inside"!==x?(e=c.y1,g=c.y2,0<v?(f=m.point.y+("horizontal"===z?s/2:0)-k-t-b,f<e&&(f="auto"===x?Math.max(m.point.y,e)+s/2+t:e+s/2+t,A=f+k>m.point.y)):(f=m.point.y+s/2+t+b,f>g-k&&(f="auto"===x?Math.min(m.point.y,g)+s/2-k-t:g+s/2-k,A=f<m.point.y))):(e=Math.max(m.bounds.y1,c.y1),g=Math.min(m.bounds.y2,c.y2-k+s/2),b=0<=p.indexOf("range")||"error"===p?0<v?Math.max(m.bounds.y1,c.y1)+s/2+t:Math.min(m.bounds.y2,c.y2)+s/2-k+t:(Math.max(m.bounds.y1,c.y1)+Math.min(m.bounds.y2,c.y2))/
2-k/2+s/2+("horizontal"===z?t:0),0<v?(f=Math.max(m.point.y,b),f<e&&("bubble"===p||"scatter"===p)&&(f=Math.max(m.point.y-k-t,c.y1+t))):(f=Math.min(m.point.y,b),f>g-k-t&&("bubble"===p||"scatter"===p)&&(f=Math.min(m.point.y+t,c.y2-k-t))),f=Math.min(f,g))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("scatter")?(x="auto",l=4):0<=p.indexOf("stacked")?"auto"===x&&(x="inside"):"bubble"===p&&(x="inside"),f=m.point.y+s/2-k/2+t,"inside"!==x?(e=c.x1,g=c.x2,0>v?(q=m.point.x-("horizontal"===z?
D:D-s/2)-l-b,q<e&&(q="auto"===x?Math.max(m.point.x,e)+l:e+l,A=q+D>m.point.x)):(q=m.point.x+("horizontal"===z?0:s/2)+l+b,q>g-D-l-b&&(q="auto"===x?Math.min(m.point.x,g)-("horizontal"===z?D:D/2)-l:g-D-l,A=q<m.point.x))):(e=Math.max(m.bounds.x1,c.x1),Math.min(m.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>v?Math.max(m.bounds.x1,c.x1)+s/2+l:Math.min(m.bounds.x2,c.x2)-D/2-l+("horizontal"===z?0:s/2):(Math.max(m.bounds.x1,c.x1)+Math.min(m.bounds.x2,c.x2))/2+("horizontal"===z?0:s/2),q=0>v?Math.max(m.point.x,
b)-("horizontal"===z?D/2:0):Math.min(m.point.x,b)-D/2,q=Math.max(q,e));"vertical"===z&&(f+=k-s/2);h.x=q;h.y=f;h.render(!0);n&&("inside"!==x&&(0>p.indexOf("bar")&&("error"!==p||!m.axisSwapped)&&m.point.x>c.x1&&m.point.x<c.x2||!A)&&(0>p.indexOf("column")&&("error"!==p||m.axisSwapped)&&m.point.y>c.y1&&m.point.y<c.y2||!A))&&(d.lineWidth=n,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(J(ba,n)),d.beginPath(),d.moveTo(m.point.x,m.point.y),0<=p.indexOf("bar")||"error"===p&&m.axisSwapped?d.lineTo(q+
(0<m.direction?-l:D+l)+("vertical"===z?-s/2:0),f+("vertical"===z?-k/2:k/2-s/2)-t):0<=p.indexOf("column")||"error"===p&&!m.axisSwapped?d.lineTo(q+D/2-("horizontal"===z?0:s/2),f+("vertical"===z?(f-k<m.point.y?0:-k)+t:(f-s/2<m.point.y?k:0)-s/2)):d.lineTo(q+D/2-("horizontal"===z?0:s/2),f+("vertical"===z?f-k<m.point.y?0:-k:(f-s/2<m.point.y?k:0)-s/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};
for(a=0;a<this._indexLabels.length;a++)m=this._indexLabels[a],h=ma("indexLabelBackgroundColor",m.dataPoint,m.dataSeries),m.dataSeries.indexLabelBackgroundColor=r(h)?w?"transparent":null:h;return d};n.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var g=[],l,t=0;t<a.dataSeriesIndexes.length;t++){var D=
a.dataSeriesIndexes[t],k=this.data[D];c.lineWidth=k.lineThickness;var m=k.dataPoints,p="solid";if(c.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,f=J(p,k.lineThickness);c.setLineDash(f)}var s=k.id;this._eventManager.objectMap[s]={objectType:"dataSeries",dataSeriesIndex:D};s=X(s);b.strokeStyle=s;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var s=k._colorSet,h=s=k.lineColor=k.options.lineColor?k.options.lineColor:s[0];c.strokeStyle=s;var r=!0,u=0,n,x;c.beginPath();
...
k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(n,x),h=m[u].lineColor||s,c.strokeStyle=h,c.setLineDash&&(m[u].lineDashType?(p=m[u].lineDashType,c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(f))));if(0!==m[u].markerSize&&(0<m[u].markerSize||0<k.markerSize)){var C=k.getMarkerProperties(u,n,x,c);g.push(C);H=X(H);w&&g.push({x:n,y:x,ctx:b,type:C.type,size:C.size,color:H,borderColor:H,borderThickness:C.borderThickness})}(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||
k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[u],dataSeries:k,point:{x:n,y:x},direction:0>m[u].y===a.axisY.reversed?1:-1,color:s})}c.stroke();w&&b.stroke()}}W.drawMarkers(g);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
(b.stroke(),b.beginPath(),b.moveTo(n,x))));l={x:n,y:x};u<m.length-1&&(h!==(m[u].lineColor||s)||p!==(m[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(n,x),h=m[u].lineColor||s,c.strokeStyle=h,c.setLineDash&&(m[u].lineDashType?(p=m[u].lineDashType,c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(f))));0!==m[u].markerSize&&(0<m[u].markerSize||0<k.markerSize)&&(H=k.getMarkerProperties(u,n,x,c),g.push(H),C=X(C),w&&g.push({x:n,y:x,ctx:b,type:H.type,size:H.size,
color:C,borderColor:C,borderThickness:H.borderThickness}));(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:m[u],dataSeries:k,point:{x:n,y:x},direction:0>m[u].y===a.axisY.reversed?1:-1,color:s})}c.stroke();w&&b.stroke()}}W.drawMarkers(g);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
k.dataPoints,p="solid";if(b.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,f=J(p,k.lineThickness);b.setLineDash(f)}var s=k.id;this._eventManager.objectMap[s]={objectType:"dataSeries",dataSeriesIndex:D};s=X(s);e.strokeStyle=s;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var s=k._colorSet,h=s=k.lineColor=k.options.lineColor?k.options.lineColor:s[0];b.strokeStyle=s;var r=0,u,n,x=[];b.beginPath();if(0<m.length)for(n=!1,r=0;r<m.length;r++)if(u=m[r].getTime?
...
dataPointIndex:r,x1:u,y1:n};x[x.length]={x:u,y:n};r<m.length-1&&(h!==(m[r].lineColor||s)||p!==(m[r].lineDashType||k.lineDashType))&&(h=m[r].lineColor||s,x[x.length-1].newStrokeStyle=h,b.setLineDash&&(m[r].lineDashType?(p=m[r].lineDashType,x[x.length-1].newLineDashArray=J(p,k.lineThickness)):(p=k.lineDashType,x[x.length-1].newLineDashArray=f)));if(0!==m[r].markerSize&&(0<m[r].markerSize||0<k.markerSize)){var H=k.getMarkerProperties(r,u,n,b);l.push(H);z=X(z);w&&l.push({x:u,y:n,ctx:e,type:H.type,size:H.size,
...
b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(g.x1,g.y1,g.width,g.height),e.beginPath());b.restore();b.beginPath();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
null,e=this.plotArea,g=0,l,t,D,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),g=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.dataPointWidth=this.options.dataPointWidth?
this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&g>m&&(g=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<g)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,g));p<g&&(p=g);p>m&&(p=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);
c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var q=a.dataSeriesIndexes[m],f=this.data[q],s=f.dataPoints;if(0<s.length)for(var h=5<p&&f.bevelEnabled?!0:!1,g=0;g<s.length;g++)if(s[g].getTime?D=s[g].x.getTime():D=s[g].x,!(D<a.axisX.dataInfo.viewPortMin||D>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[g].y){l=a.axisX.convertValueToPixel(D);t=a.axisY.convertValueToPixel(s[g].y);
l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var r=a.axisX.reversed?l-p<<0:l+p<<0,u;0<=s[g].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=s[g].color?s[g].color:f._colorSet[g%f._colorSet.length];Y(c,a.axisX.reversed?r:l,t,a.axisX.reversed?l:r,u,b,0,null,h&&(a.axisY.reversed?0>s[g].y:0<=s[g].y),(a.axisY.reversed?0<=s[g].y:0>s[g].y)&&h,!1,!1,f.fillOpacity);b=f.dataPointIds[g];this._eventManager.objectMap[b]=
{id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:g,x1:l,y1:t,x2:r,y2:u};b=X(b);w&&Y(this._eventManager.ghostCtx,a.axisX.reversed?r:l,t,a.axisX.reversed?l:r,u,b,0,null,!1,!1,!1,!1);(s[g].indexLabel||f.indexLabel||s[g].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:s[g],dataSeries:f,point:{x:l+(r-l)/2,y:0>s[g].y===a.axisY.reversed?t:u},direction:0>s[g].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(t,u),x2:r,y2:Math.max(t,u)},color:b})}}w&&
...
easingFunction:M.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};n.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,g=[],l=[],t=[],D=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
1,f=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0,s=a.axisX.dataInfo.minDiff;isFinite(s)||(s=0.3*Math.abs(a.axisX.range));s=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>f&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,f));!this.dataPointMaxWidth&&
(this.dataPointMinWidth&&f<k)&&(f=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));s<k&&(s=k);s>f&&(s=f);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(f=0;f<a.dataSeriesIndexes.length;f++){var h=a.dataSeriesIndexes[f],r=this.data[h],u=r.dataPoints;if(0<u.length){var n=5<s&&r.bevelEnabled?
...
k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,f=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0,s=a.axisX.dataInfo.minDiff;isFinite(s)||(s=0.3*Math.abs(a.axisX.range));s=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&
k>f&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,f));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&f<k)&&(f=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));s<k&&(s=k);s>f&&(s=f);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(f=0;f<a.dataSeriesIndexes.length;f++){var h=
a.dataSeriesIndexes[f],r=this.data[h],u=r.dataPoints;if(0<u.length)for(var n=5<s&&r.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;m=m-a.plotType.plotUnits.length*s/2+a.index*s<<0;var x=m+s<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0<u[k].y){t[b]=p+("undefined"!==typeof t[b]?t[b]:0);if(0>=t[b])continue;p=a.axisY.convertValueToPixel(t[b]);z=g[b]?g[b]:q;g[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)D[b]=p+("undefined"!==typeof D[b]?D[b]:0),z=a.axisY.convertValueToPixel(D[b]),p=l[b]?l[b]:q,l[b]=z;else if(p=a.axisY.convertValueToPixel(p),0<=u[k].y){var H="undefined"!==typeof g[b]?g[b]:0;p-=H;z=q-H;a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.y1-p)&&(p=e.y1);g[b]=H+(z-p)}else H="undefined"!==
typeof l[b]?l[b]:0,z=p+H,p=q+H,a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.y2-z)&&(z=e.y2),l[b]=H+(z-p);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];Y(c,m,a.axisY.reversed?z:p,x,a.axisY.reversed?p:z,b,0,null,n&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&n,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:m,y1:p,x2:x,y2:z};b=X(b);w&&Y(this._eventManager.ghostCtx,
...
function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,g=0,l,t,D,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),g=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<
0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&g>m&&(g=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<g)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,g));p<g&&(p=
g);p>m&&(p=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var q=a.dataSeriesIndexes[m],f=this.data[q],s=f.dataPoints;if(0<s.length){var h=5<p&&f.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(g=0;g<s.length;g++)if(s[g].getTime?D=s[g].x.getTime():D=s[g].x,!(D<
a.axisX.dataInfo.viewPortMin||D>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[g].y){t=a.axisX.convertValueToPixel(D);l=a.axisY.convertValueToPixel(s[g].y);t=a.axisX.reversed?t+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:t-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var r=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=s[g].y?u=k:(u=l,l=k);b=s[g].color?s[g].color:f._colorSet[g%f._colorSet.length];Y(c,a.axisY.reversed?l:u,a.axisX.reversed?r:t,a.axisY.reversed?u:
l,a.axisX.reversed?t:r,b,0,null,h,!1,!1,!1,f.fillOpacity);b=f.dataPointIds[g];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:g,x1:u,y1:t,x2:l,y2:r};b=X(b);w&&Y(this._eventManager.ghostCtx,u,a.axisX.reversed?r:t,l,a.axisX.reversed?t:r,b,0,null,!1,!1,!1,!1);(s[g].indexLabel||f.indexLabel||s[g].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:s[g],dataSeries:f,point:{x:0<=s[g].y?l:u,y:t+(r-t)/2},direction:0>
s[g].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(u,l),y1:t,x2:Math.max(u,l),y2:r},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),
...
a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,f=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0,s=a.axisX.dataInfo.minDiff;isFinite(s)||(s=0.3*Math.abs(a.axisX.range));s=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<
0;this.dataPointMaxWidth&&k>f&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,f));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&f<k)&&(f=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));s<k&&(s=k);s>f&&(s=f);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());
for(f=0;f<a.dataSeriesIndexes.length;f++){var h=a.dataSeriesIndexes[f],r=this.data[h],u=r.dataPoints;if(0<u.length){var n=5<s&&r.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);p=p-a.plotType.plotUnits.length*s/2+a.index*s<<0;var x=p+s<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(z=g[b]?g[b]:q,g[b]=m=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)D[b]=u[k].y+(D[b]?D[b]:0),m=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(D[b]);else if(m=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var H=g[b]?g[b]:0;z=q+H;m+=H;g[b]=H+(m-z)}else H=l[b]?l[b]:0,z=m-H,m=q-H,l[b]=H+(m-z);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];Y(c,a.axisY.reversed?m:z,p,a.axisY.reversed?
...
this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,f=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0,s=a.axisX.dataInfo.minDiff;isFinite(s)||(s=0.3*Math.abs(a.axisX.range));s=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>f&&(k=Math.min(this.options.dataPointWidth?
this.dataPointWidth:Infinity,f));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&f<k)&&(f=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));s<k&&(s=k);s>f&&(s=f);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(f=0;f<a.dataSeriesIndexes.length;f++){var h=a.dataSeriesIndexes[f],
...
0<u[k].y){t[b]=x+(t[b]?t[b]:0);if(0>=t[b])continue;x=g[b]?g[b]:q;g[b]=m=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)D[b]=x+(D[b]?D[b]:0),m=l[b]?l[b]:q,l[b]=x=a.axisY.convertValueToPixel(D[b]);else if(m=a.axisY.convertValueToPixel(x),0<=u[k].y){var H=g[b]?g[b]:0;x=q+H;m+=H;a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.x2-m)&&(m=e.x2);g[b]=H+(m-x)}else H=l[b]?l[b]:0,x=m-H,m=q-H,a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.x1-
...
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};n.prototype.renderArea=function(a){var d,c;function b(){H&&(0<f.lineThickness&&g.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=x:0>a.axisY.viewportMaximum?
z=t.y1:0<a.axisY.viewportMinimum&&(z=x),g.lineTo(r,z),g.lineTo(H.x,z),g.closePath(),g.globalAlpha=f.fillOpacity,g.fill(),g.globalAlpha=1,w&&(l.lineTo(r,z),l.lineTo(H.x,z),l.closePath(),l.fill()),g.beginPath(),g.moveTo(r,u),l.beginPath(),l.moveTo(r,u),H={x:r,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,g=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,D=[],k=this.plotArea,m;g.save();w&&l.save();g.beginPath();g.rect(k.x1,k.y1,
k.width,k.height);g.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],f=this.data[q],s=f.dataPoints,D=f.id;this._eventManager.objectMap[D]={objectType:"dataSeries",dataSeriesIndex:q};D=X(D);l.fillStyle=D;D=[];d=!0;var h=0,r,u,n,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z,H=null;if(0<s.length){var C=f._colorSet[h%f._colorSet.length],v=f.lineColor=f.options.lineColor||C,
A=v;g.fillStyle=C;g.strokeStyle=v;g.lineWidth=f.lineThickness;c="solid";if(g.setLineDash){var L=J(f.nullDataLineDashType,f.lineThickness);c=f.lineDashType;var S=J(c,f.lineThickness);g.setLineDash(S)}for(var ea=!0;h<s.length;h++)if(n=s[h].x.getTime?s[h].x.getTime():s[h].x,!(n<a.axisX.dataInfo.viewPortMin||n>a.axisX.dataInfo.viewPortMax&&(!f.connectNullData||!ea)))if("number"!==typeof s[h].y)f.connectNullData||(ea||d)||b(),ea=!0;else{r=a.axisX.convertValueToPixel(n);u=a.axisY.convertValueToPixel(s[h].y);
d||ea?(!d&&f.connectNullData?(g.setLineDash&&(f.options.nullDataLineDashType||c===f.lineDashType&&f.lineDashType!==f.nullDataLineDashType)&&(d=r,c=u,r=m.x,u=m.y,b(),g.moveTo(m.x,m.y),r=d,u=c,H=m,c=f.nullDataLineDashType,g.setLineDash(L)),g.lineTo(r,u),w&&l.lineTo(r,u)):(g.beginPath(),g.moveTo(r,u),w&&(l.beginPath(),l.moveTo(r,u)),H={x:r,y:u}),ea=d=!1):(g.lineTo(r,u),w&&l.lineTo(r,u),0==h%250&&b());m={x:r,y:u};h<s.length-1&&(A!==(s[h].lineColor||v)||c!==(s[h].lineDashType||f.lineDashType))&&(b(),A=
s[h].lineColor||v,g.strokeStyle=A,g.setLineDash&&(s[h].lineDashType?(c=s[h].lineDashType,g.setLineDash(J(c,f.lineThickness))):(c=f.lineDashType,g.setLineDash(S))));var $=f.dataPointIds[h];this._eventManager.objectMap[$]={id:$,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:r,y1:u};0!==s[h].markerSize&&(0<s[h].markerSize||0<f.markerSize)&&(n=f.getMarkerProperties(h,r,u,g),D.push(n),$=X($),w&&D.push({x:r,y:u,ctx:l,type:n.type,size:n.size,color:$,borderColor:$,borderThickness:n.borderThickness}));
(s[h].indexLabel||f.indexLabel||s[h].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:s[h],dataSeries:f,point:{x:r,y:u},direction:0>s[h].y===a.axisY.reversed?1:-1,color:C})}b();W.drawMarkers(D)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),g.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&g.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&g.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),g.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());g.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderSplineArea=function(a){function d(){var c=v(y,2);if(0<c.length){if(0<m.lineThickness){b.beginPath();b.moveTo(c[0].x,c[0].y);c[0].newStrokeStyle&&(b.strokeStyle=c[0].newStrokeStyle);
...
c[0].y);w&&(e.beginPath(),e.moveTo(c[0].x,c[0].y));for(d=0;d<c.length-3;d+=3)b.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),w&&e.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y);a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?n=r:0>a.axisY.viewportMaximum?n=g.y1:0<a.axisY.viewportMinimum&&(n=r);u={x:c[0].x,y:c[0].y};b.lineTo(c[c.length-1].x,n);b.lineTo(u.x,n);b.closePath();b.globalAlpha=m.fillOpacity;b.fill();b.globalAlpha=1;
w&&(e.lineTo(c[c.length-1].x,n),e.lineTo(u.x,n),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,g=a.axisY.lineCoordinates,l=[],t=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(e.beginPath(),e.rect(t.x1,t.y1,t.width,t.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var k=a.dataSeriesIndexes[h],m=this.data[k],p=m.dataPoints,
l=m.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=X(l);e.fillStyle=l;var l=[],q=0,f,s,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),n,u=null,y=[];if(0<p.length){var x=m._colorSet[q%m._colorSet.length],z=m.lineColor=m.options.lineColor||x,H=z;b.fillStyle=x;b.strokeStyle=z;b.lineWidth=m.lineThickness;var C="solid";if(b.setLineDash){var A=J(m.nullDataLineDashType,m.lineThickness),C=m.lineDashType,B=J(C,m.lineThickness);b.setLineDash(B)}for(s=
!1;q<p.length;q++)if(f=p[q].x.getTime?p[q].x.getTime():p[q].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!s)))if("number"!==typeof p[q].y)0<q&&!s&&(m.connectNullData?b.setLineDash&&(0<y.length&&(m.options.nullDataLineDashType||!p[q-1].lineDashType))&&(y[y.length-1].newLineDashArray=A,C=m.nullDataLineDashType):(d(),y=[])),s=!0;else{f=a.axisX.convertValueToPixel(f);s=a.axisY.convertValueToPixel(p[q].y);var L=m.dataPointIds[q];this._eventManager.objectMap[L]=
{id:L,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:f,y1:s};y[y.length]={x:f,y:s};q<p.length-1&&(H!==(p[q].lineColor||z)||C!==(p[q].lineDashType||m.lineDashType))&&(H=p[q].lineColor||z,y[y.length-1].newStrokeStyle=H,b.setLineDash&&(p[q].lineDashType?(C=p[q].lineDashType,y[y.length-1].newLineDashArray=J(C,m.lineThickness)):(C=m.lineDashType,y[y.length-1].newLineDashArray=B)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<m.markerSize)){var S=m.getMarkerProperties(q,f,s,b);l.push(S);
L=X(L);w&&l.push({x:f,y:s,ctx:e,type:S.type,size:S.size,color:L,borderColor:L,borderThickness:S.borderThickness})}(p[q].indexLabel||m.indexLabel||p[q].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:m,point:{x:f,y:s},direction:0>p[q].y===a.axisY.reversed?1:-1,color:x});s=!1}d();W.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStepArea=function(a){var d,c;function b(){H&&(0<f.lineThickness&&
g.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=x:0>a.axisY.viewportMaximum?z=t.y1:0<a.axisY.viewportMinimum&&(z=x),g.lineTo(n,z),g.lineTo(H.x,z),g.closePath(),g.globalAlpha=f.fillOpacity,g.fill(),g.globalAlpha=1,w&&(l.lineTo(n,z),l.lineTo(H.x,z),l.closePath(),l.fill()),g.beginPath(),g.moveTo(n,u),l.beginPath(),l.moveTo(n,u),H={x:n,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,g=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,
t=a.axisY.lineCoordinates,h=[],k=this.plotArea,m;g.save();w&&l.save();g.beginPath();g.rect(k.x1,k.y1,k.width,k.height);g.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],f=this.data[q],s=f.dataPoints,h=f.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:q};h=X(h);l.fillStyle=h;h=[];d=!0;var r=0,n,u,y,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
z,H=null;c=!1;if(0<s.length){var C=f._colorSet[r%f._colorSet.length],v=f.lineColor=f.options.lineColor||C,A=v;g.fillStyle=C;g.strokeStyle=v;g.lineWidth=f.lineThickness;var L="solid";if(g.setLineDash){var S=J(f.nullDataLineDashType,f.lineThickness),L=f.lineDashType,B=J(L,f.lineThickness);g.setLineDash(B)}for(;r<s.length;r++)if(y=s[r].x.getTime?s[r].x.getTime():s[r].x,!(y<a.axisX.dataInfo.viewPortMin||y>a.axisX.dataInfo.viewPortMax&&(!f.connectNullData||!c))){var $=u;"number"!==typeof s[r].y?(f.connectNullData||
(c||d)||b(),c=!0):(n=a.axisX.convertValueToPixel(y),u=a.axisY.convertValueToPixel(s[r].y),d||c?(!d&&f.connectNullData?(g.setLineDash&&(f.options.nullDataLineDashType||L===f.lineDashType&&f.lineDashType!==f.nullDataLineDashType)&&(d=n,c=u,n=m.x,u=m.y,b(),g.moveTo(m.x,m.y),n=d,u=c,H=m,L=f.nullDataLineDashType,g.setLineDash(S)),g.lineTo(n,$),g.lineTo(n,u),w&&(l.lineTo(n,$),l.lineTo(n,u))):(g.beginPath(),g.moveTo(n,u),w&&(l.beginPath(),l.moveTo(n,u)),H={x:n,y:u}),c=d=!1):(g.lineTo(n,$),w&&l.lineTo(n,
$),g.lineTo(n,u),w&&l.lineTo(n,u),0==r%250&&b()),m={x:n,y:u},r<s.length-1&&(A!==(s[r].lineColor||v)||L!==(s[r].lineDashType||f.lineDashType))&&(b(),A=s[r].lineColor||v,g.strokeStyle=A,g.setLineDash&&(s[r].lineDashType?(L=s[r].lineDashType,g.setLineDash(J(L,f.lineThickness))):(L=f.lineDashType,g.setLineDash(B)))),y=f.dataPointIds[r],this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:r,x1:n,y1:u},0!==s[r].markerSize&&(0<s[r].markerSize||0<f.markerSize)&&($=
f.getMarkerProperties(r,n,u,g),h.push($),y=X(y),w&&h.push({x:n,y:u,ctx:l,type:$.type,size:$.size,color:y,borderColor:y,borderThickness:$.borderThickness})),(s[r].indexLabel||f.indexLabel||s[r].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:s[r],dataSeries:f,point:{x:n,y:u},direction:0>s[r].y===a.axisY.reversed?1:-1,color:C}))}b();W.drawMarkers(h)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),g.globalCompositeOperation="source-atop",
a.axisX.maskCanvas&&g.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&g.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),g.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());g.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStackedArea=
function(a){function d(){if(!(1>k.length)){for(0<C.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&n.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(n.closePath(),n.fill(),n.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,g=null,l=[],t=this.plotArea,h=[],k=[],m=[],p=[],q=0,f,s,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:
...
C=this.data[H];v=C.dataPoints;y=!0;k=[];q=C.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:H};q=X(q);n.fillStyle=q;if(0<m.length){var e=C._colorSet[0],A=C.lineColor=C.options.lineColor||e,L=A;b.fillStyle=e;b.strokeStyle=A;b.lineWidth=C.lineThickness;x="solid";if(b.setLineDash){var S=J(C.nullDataLineDashType,C.lineThickness);x=C.lineDashType;var B=J(x,C.lineThickness);b.setLineDash(B)}for(var $=!0,q=0;q<m.length;q++){var g=m[q],ga=null,ga=0<=C.dataPointIndexes[g]?v[C.dataPointIndexes[g]]:
{x:g,y:null};if(!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!$)))if("number"!==typeof ga.y)C.connectNullData||($||y)||d(),$=!0;else{f=a.axisX.convertValueToPixel(g);var na=h[g]?h[g]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[g]=ga.y+(p[g]?p[g]:0);if(0>=p[g]&&a.axisY.logarithmic)continue;s=a.axisY.convertValueToPixel(p[g])}else s=a.axisY.convertValueToPixel(ga.y),s-=na;k.push({x:f,y:r-na});h[g]=r-s;y||$?(!y&&
C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||x===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(y=k.pop(),x=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(x),k.push(y),x=C.nullDataLineDashType,b.setLineDash(S)),b.lineTo(f,s),w&&n.lineTo(f,s)):(b.beginPath(),b.moveTo(f,s),w&&(n.beginPath(),n.moveTo(f,s))),$=y=!1):(b.lineTo(f,s),w&&n.lineTo(f,s),0==q%250&&(d(),b.moveTo(f,s),w&&n.moveTo(f,s),k.push({x:f,y:r-na})));u={x:f,y:s};q<v.length-1&&(L!==(v[q].lineColor||A)||x!==
(v[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(f,s),k.push({x:f,y:r-na}),L=v[q].lineColor||A,b.strokeStyle=L,b.setLineDash&&(v[q].lineDashType?(x=v[q].lineDashType,b.setLineDash(J(x,C.lineThickness))):(x=C.lineDashType,b.setLineDash(B))));if(0<=C.dataPointIndexes[g]){var ka=C.dataPointIds[C.dataPointIndexes[g]];this._eventManager.objectMap[ka]={id:ka,objectType:"dataPoint",dataSeriesIndex:H,dataPointIndex:C.dataPointIndexes[g],x1:f,y1:s}}0<=C.dataPointIndexes[g]&&0!==ga.markerSize&&
(0<ga.markerSize||0<C.markerSize)&&(na=C.getMarkerProperties(C.dataPointIndexes[g],f,s,b),l.push(na),g=X(ka),w&&l.push({x:f,y:s,ctx:n,type:na.type,size:na.size,color:g,borderColor:g,borderThickness:na.borderThickness}));(ga.indexLabel||C.indexLabel||ga.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ga,dataSeries:C,point:{x:f,y:s},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(f,s);w&&n.moveTo(f,s)}delete C.dataPointIndexes}W.drawMarkers(l);
...
!0,q=0;q<m.length;q++){var g=m[q],ga=null,ga=0<=C.dataPointIndexes[g]?v[C.dataPointIndexes[g]]:{x:g,y:null};if(!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!$)))if("number"!==typeof ga.y)C.connectNullData||($||n)||d(),$=!0;else{var na;na=0!==a.dataPointYSums[g]?100*(ga.y/a.dataPointYSums[g]):0;f=a.axisX.convertValueToPixel(g);var ka=h[g]?h[g]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[g]=na+(p[g]?p[g]:0);
if(0>=p[g]&&a.axisY.logarithmic)continue;s=a.axisY.convertValueToPixel(p[g])}else s=a.axisY.convertValueToPixel(na),s-=ka;k.push({x:f,y:y-ka});h[g]=y-s;n||$?(!n&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||u===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(n=k.pop(),u=k[k.length-1],d(),b.moveTo(r.x,r.y),k.push(u),k.push(n),u=C.nullDataLineDashType,b.setLineDash(S)),b.lineTo(f,s),w&&x.lineTo(f,s)):(b.beginPath(),b.moveTo(f,s),w&&(x.beginPath(),x.moveTo(f,s))),$=n=
!1):(b.lineTo(f,s),w&&x.lineTo(f,s),0==q%250&&(d(),b.moveTo(f,s),w&&x.moveTo(f,s),k.push({x:f,y:y-ka})));r={x:f,y:s};q<v.length-1&&(L!==(v[q].lineColor||A)||u!==(v[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(f,s),k.push({x:f,y:y-ka}),L=v[q].lineColor||A,b.strokeStyle=L,b.setLineDash&&(v[q].lineDashType?(u=v[q].lineDashType,b.setLineDash(J(u,C.lineThickness))):(u=C.lineDashType,b.setLineDash(B))));if(0<=C.dataPointIndexes[g]){var F=C.dataPointIds[C.dataPointIndexes[g]];this._eventManager.objectMap[F]=
{id:F,objectType:"dataPoint",dataSeriesIndex:H,dataPointIndex:C.dataPointIndexes[g],x1:f,y1:s}}0<=C.dataPointIndexes[g]&&0!==ga.markerSize&&(0<ga.markerSize||0<C.markerSize)&&(ka=C.getMarkerProperties(q,f,s,b),t.push(ka),g=X(F),w&&t.push({x:f,y:s,ctx:x,type:ka.type,size:ka.size,color:g,borderColor:g,borderThickness:ka.borderThickness}));(ga.indexLabel||C.indexLabel||ga.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ga,dataSeries:C,point:{x:f,
y:s},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(f,s);w&&x.moveTo(f,s)}delete C.dataPointIndexes}W.drawMarkers(t);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
b.clearRect(l.x1,l.y1,l.width,l.height),x.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,g,l;c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),
this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var t=-Infinity,h=Infinity,k=0;k<a.dataSeriesIndexes.length;k++)for(var m=a.dataSeriesIndexes[k],p=this.data[m],q=p.dataPoints,f=0,e=0;e<q.length;e++)g=q[e].getTime?g=q[e].x.getTime():g=q[e].x,g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax||"undefined"===typeof q[e].z||(f=q[e].z,f>t&&(t=f),f<h&&(h=f));for(var s=25*Math.PI,r=Math.max(Math.pow(0.25*Math.min(b.height,b.width)/2,2)*Math.PI,
s),k=0;k<a.dataSeriesIndexes.length;k++)if(m=a.dataSeriesIndexes[k],p=this.data[m],q=p.dataPoints,0<q.length)for(c.strokeStyle="#4572A7 ",e=0;e<q.length;e++)if(g=q[e].getTime?g=q[e].x.getTime():g=q[e].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){g=a.axisX.convertValueToPixel(g);l=a.axisY.convertValueToPixel(q[e].y);var f=q[e].z,n=2*Math.max(Math.sqrt((t===h?r/2:s+(r-s)/(t-h)*(f-h))/Math.PI)<<0,1),f=p.getMarkerProperties(e,c);f.size=n;c.globalAlpha=
p.fillOpacity;W.drawMarker(g,l,c,f.type,f.size,f.color,f.borderColor,f.borderThickness);c.globalAlpha=1;var u=p.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:e,x1:g,y1:l,size:n};n=X(u);w&&W.drawMarker(g,l,this._eventManager.ghostCtx,f.type,f.size,n,n,f.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:g,y:l},
direction:1,bounds:{x1:g-f.size/2,y1:l-f.size/2,x2:g+f.size/2,y2:l+f.size/2},color:null})}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());
...
b.width,b.height),this._eventManager.ghostCtx.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],m=k.dataPoints;if(0<m.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,b.width)/2,2);for(var p=0,q=0,e=0;e<m.length;e++)if(g=m[e].getTime?g=m[e].x.getTime():g=m[e].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&"number"===typeof m[e].y){g=a.axisX.convertValueToPixel(g);l=a.axisY.convertValueToPixel(m[e].y);var f=k.getMarkerProperties(e,
g,l,c);c.globalAlpha=k.fillOpacity;W.drawMarker(f.x,f.y,f.ctx,f.type,f.size,f.color,f.borderColor,f.borderThickness);c.globalAlpha=1;Math.sqrt((p-g)*(p-g)+(q-l)*(q-l))<Math.min(f.size,5)&&m.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:g,y1:l},p=X(p),w&&W.drawMarker(f.x,f.y,this._eventManager.ghostCtx,f.type,f.size,p,p,f.borderThickness),(m[e].indexLabel||k.indexLabel||
m[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:m[e],dataSeries:k,point:{x:g,y:l},direction:1,bounds:{x1:g-f.size/2,y1:l-f.size/2,x2:g+f.size/2,y2:l+f.size/2},color:null}),p=g,q=l)}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
n.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,g=this.plotArea,l=0,t,h,k,m,p,q,f,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.015*this.width,s=a.axisX.dataInfo.minDiff;isFinite(s)||(s=0.3*Math.abs(a.axisX.range));
s=this.options.dataPointWidth?this.dataPointWidth:0.7*g.width*(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));s<e&&(s=e);s>l&&(s=l);c.save();w&&b.save();c.beginPath();c.rect(g.x1,g.y1,g.width,g.height);c.clip();w&&(b.beginPath(),
b.rect(g.x1,g.y1,g.width,g.height),b.clip());for(var n=!1,n=!!a.axisY.reversed,ba=0;ba<a.dataSeriesIndexes.length;ba++){var u=a.dataSeriesIndexes[ba],y=this.data[u],x=y.dataPoints;if(0<x.length)for(var z=5<s&&y.bevelEnabled?!0:!1,l=0;l<x.length;l++)if(x[l].getTime?f=x[l].x.getTime():f=x[l].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&!r(x[l].y)&&x[l].y.length&&"number"===typeof x[l].y[0]&&"number"===typeof x[l].y[1]&&"number"===typeof x[l].y[2]&&"number"===typeof x[l].y[3]&&
"number"===typeof x[l].y[4]&&5===x[l].y.length){t=a.axisX.convertValueToPixel(f);h=a.axisY.convertValueToPixel(x[l].y[0]);k=a.axisY.convertValueToPixel(x[l].y[1]);m=a.axisY.convertValueToPixel(x[l].y[2]);p=a.axisY.convertValueToPixel(x[l].y[3]);q=a.axisY.convertValueToPixel(x[l].y[4]);var v=t-s/2<<0,C=t+s/2<<0,e=x[l].color?x[l].color:y._colorSet[0],A=Math.round(Math.max(1,0.15*s)),B=0===A%2?0:0.5,L=x[l].whiskerColor?x[l].whiskerColor:x[l].color?y.whiskerColor?y.whiskerColor:x[l].color:y.whiskerColor?
...
c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(g.x1,g.y1,g.width,g.height),b.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeColumn=
function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,g=0,l,t,h,g=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.03*this.width;var k=a.axisX.dataInfo.minDiff;isFinite(k)||(k=0.3*Math.abs(a.axisX.range));k=this.options.dataPointWidth?this.dataPointWidth:
0.9*(e.width*(a.axisX.logarithmic?Math.log(k)/Math.log(a.axisX.range):Math.abs(k)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&g>l&&(g=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<g)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,g));k<g&&(k=g);k>l&&(k=l);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),
this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var p=a.dataSeriesIndexes[m],q=this.data[p],f=q.dataPoints;if(0<f.length)for(var s=5<k&&q.bevelEnabled?!0:!1,g=0;g<f.length;g++)if(f[g].getTime?h=f[g].x.getTime():h=f[g].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax)&&!r(f[g].y)&&f[g].y.length&&"number"===typeof f[g].y[0]&&"number"===typeof f[g].y[1]){b=a.axisX.convertValueToPixel(h);l=
a.axisY.convertValueToPixel(f[g].y[0]);t=a.axisY.convertValueToPixel(f[g].y[1]);var n=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+m)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+m)*k<<0,ba=a.axisX.reversed?n-k<<0:n+k<<0,b=f[g].color?f[g].color:q._colorSet[g%q._colorSet.length];if(l>t){var u=l;l=t;t=u}u=q.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:g,x1:n,y1:l,x2:ba,y2:t};Y(c,a.axisX.reversed?
ba:n,l,a.axisX.reversed?n:ba,t,b,0,b,s,s,!1,!1,q.fillOpacity);b=X(u);w&&Y(this._eventManager.ghostCtx,a.axisX.reversed?ba:n,l,a.axisX.reversed?n:ba,t,b,0,null,!1,!1,!1,!1);if(f[g].indexLabel||q.indexLabel||f[g].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:f[g],dataSeries:q,indexKeyword:0,point:{x:n+(ba-n)/2,y:f[g].y[1]>=f[g].y[0]?t:l},direction:f[g].y[1]>=f[g].y[0]?-1:1,bounds:{x1:n,y1:Math.min(l,t),x2:ba,y2:Math.max(l,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",
dataPoint:f[g],dataSeries:q,indexKeyword:1,point:{x:n+(ba-n)/2,y:f[g].y[1]>=f[g].y[0]?l:t},direction:f[g].y[1]>=f[g].y[0]?1:-1,bounds:{x1:n,y1:Math.min(l,t),x2:ba,y2:Math.max(l,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderError=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=a.axisY._position?"left"===a.axisY._position||"right"===a.axisY._position?!1:!0:!1;if(!(0>=a.dataSeriesIndexes.length)){var e=null,g=!1,l=this.plotArea,
t=0,h,k,m,p,q,f,s,n=a.axisX.dataInfo.minDiff;isFinite(n)||(n=0.3*Math.abs(a.axisX.range));c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var ba=0,u=0;u<this.data.length;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&ba||ba++;for(var y=
0;y<a.dataSeriesIndexes.length;y++){var x=a.dataSeriesIndexes[y],z=this.data[x],v=z.dataPoints,C=r(z._linkedSeries)?!1:z._linkedSeries.type.match(/(bar|column)/ig)&&z._linkedSeries.visible?!0:!1,A=0;if(C)for(e=z._linkedSeries.id,u=0;u<e;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&A||(this.data[u].type.match(/(range)/ig)&&(g=!0),A++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
1;t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(C?ba:1)))<<0:0.3*this.width;g&&(t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(C?ba:1)))<<0:0.03*this.width);u=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(n)/Math.log(a.axisX.range):
...
!r(v[t].y)&&v[t].y.length&&"number"===typeof v[t].y[0]&&"number"===typeof v[t].y[1]){var ea=a.axisX.convertValueToPixel(s);b?k=ea:h=ea;ea=a.axisY.convertValueToPixel(v[t].y[0]);b?m=ea:q=ea;ea=a.axisY.convertValueToPixel(v[t].y[1]);b?p=ea:f=ea;b?(q=a.axisX.reversed?k+(C?ba:1)*u/2-(C?A-1:0)*u<<0:k-(C?ba:1)*u/2+(C?A-1:0)*u<<0,f=a.axisX.reversed?q-u<<0:q+u<<0):(m=a.axisX.reversed?h+(C?ba:1)*u/2-(C?A-1:0)*u<<0:h-(C?ba:1)*u/2+(C?A-1:0)*u<<0,p=a.axisX.reversed?m-u<<0:m+u<<0);!b&&q>f&&(ea=q,q=f,f=ea);b&&
m>p&&(ea=m,m=p,p=ea);ea=z.dataPointIds[t];this._eventManager.objectMap[ea]={id:ea,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:t,x1:Math.min(m,p),y1:Math.min(q,f),x2:Math.max(p,m),y2:Math.max(f,q),isXYSwapped:b,stemProperties:S,whiskerProperties:L};B(c,Math.min(m,p),Math.min(q,f),Math.max(p,m),Math.max(f,q),e,L,S,b);w&&B(this._eventManager.ghostCtx,m,q,p,f,e,L,S,b);if(v[t].indexLabel||z.indexLabel||v[t].indexLabelFormatter||z.indexLabelFormatter)this._indexLabels.push({chartType:"error",
dataPoint:v[t],dataSeries:z,indexKeyword:0,point:{x:b?v[t].y[1]>=v[t].y[0]?m:p:m+(p-m)/2,y:b?q+(f-q)/2:v[t].y[1]>=v[t].y[0]?f:q},direction:v[t].y[1]>=v[t].y[0]?-1:1,bounds:{x1:b?Math.min(m,p):m,y1:b?q:Math.min(q,f),x2:b?Math.max(m,p):p,y2:b?f:Math.max(q,f)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",dataPoint:v[t],dataSeries:z,indexKeyword:1,point:{x:b?v[t].y[1]>=v[t].y[0]?p:m:m+(p-m)/2,y:b?q+(f-q)/2:v[t].y[1]>=v[t].y[0]?q:f},direction:v[t].y[1]>=v[t].y[0]?1:-1,bounds:{x1:b?
Math.min(m,p):m,y1:b?q:Math.min(q,f),x2:b?Math.max(m,p):p,y2:b?f:Math.max(q,f)},color:e,axisSwapped:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,
l.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,g=0,l,t,h,k,g=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?
this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<0;var m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));m=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&g>l&&(g=Math.min(this.options.dataPointWidth?this.dataPointWidth:
Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<g)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,g));m<g&&(m=g);m>l&&(m=l);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],f=this.data[q],
s=f.dataPoints;if(0<s.length){var n=5<m&&f.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(g=0;g<s.length;g++)if(s[g].getTime?k=s[g].x.getTime():k=s[g].x,!(k<a.axisX.dataInfo.viewPortMin||k>a.axisX.dataInfo.viewPortMax)&&!r(s[g].y)&&s[g].y.length&&"number"===typeof s[g].y[0]&&"number"===typeof s[g].y[1]){l=a.axisY.convertValueToPixel(s[g].y[0]);t=a.axisY.convertValueToPixel(s[g].y[1]);h=a.axisX.convertValueToPixel(k);h=a.axisX.reversed?h+a.plotType.totalDataSeries*m/2-(a.previousDataSeriesCount+p)*
m<<0:h-a.plotType.totalDataSeries*m/2+(a.previousDataSeriesCount+p)*m<<0;var v=a.axisX.reversed?h-m<<0:h+m<<0;l>t&&(b=l,l=t,t=b);b=s[g].color?s[g].color:f._colorSet[g%f._colorSet.length];Y(c,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,null,n,!1,!1,!1,f.fillOpacity);b=f.dataPointIds[g];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:g,x1:l,y1:h,x2:t,y2:v};b=X(b);w&&Y(this._eventManager.ghostCtx,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,null,
!1,!1,!1,!1);if(s[g].indexLabel||f.indexLabel||s[g].indexLabelFormatter||f.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:s[g],dataSeries:f,indexKeyword:0,point:{x:s[g].y[1]>=s[g].y[0]?l:t,y:h+(v-h)/2},direction:s[g].y[1]>=s[g].y[0]?-1:1,bounds:{x1:Math.min(l,t),y1:h,x2:Math.max(l,t),y2:v},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:s[g],dataSeries:f,indexKeyword:1,point:{x:s[g].y[1]>=s[g].y[0]?t:l,y:h+(v-h)/2},direction:s[g].y[1]>=s[g].y[0]?1:-1,bounds:{x1:Math.min(l,
...
b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(s,r);e.beginPath();e.moveTo(s,r);y={x:s,y:r};h=[];h.push({x:s,y1:r,y2:n})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,g=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],
m=this.data[k],p=m.dataPoints,g=m.id;this._eventManager.objectMap[g]={objectType:"dataSeries",dataSeriesIndex:k};g=X(g);e.fillStyle=g;var g=[],q=!0,f=0,s,r,n,u,y=null;if(0<p.length){var x=m._colorSet[f%m._colorSet.length],v=m.lineColor=m.options.lineColor||x,A=v;b.fillStyle=x;b.strokeStyle=v;b.lineWidth=m.lineThickness;var C="solid";if(b.setLineDash){var B=J(m.nullDataLineDashType,m.lineThickness),C=m.lineDashType,E=J(C,m.lineThickness);b.setLineDash(E)}for(var L=!0;f<p.length;f++)if(u=p[f].x.getTime?
p[f].x.getTime():p[f].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!L)))if(null!==p[f].y&&p[f].y.length&&"number"===typeof p[f].y[0]&&"number"===typeof p[f].y[1]){s=a.axisX.convertValueToPixel(u);r=a.axisY.convertValueToPixel(p[f].y[0]);n=a.axisY.convertValueToPixel(p[f].y[1]);q||L?(m.connectNullData&&!q?(b.setLineDash&&(m.options.nullDataLineDashType||C===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,C=m.nullDataLineDashType,
b.setLineDash(B)),b.lineTo(s,r),w&&e.lineTo(s,r),h.push({x:s,y1:r,y2:n})):(b.beginPath(),b.moveTo(s,r),y={x:s,y:r},h=[],h.push({x:s,y1:r,y2:n}),w&&(e.beginPath(),e.moveTo(s,r))),L=q=!1):(b.lineTo(s,r),h.push({x:s,y1:r,y2:n}),w&&e.lineTo(s,r),0==f%250&&d());u=m.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:f,x1:s,y1:r,y2:n};f<p.length-1&&(A!==(p[f].lineColor||v)||C!==(p[f].lineDashType||m.lineDashType))&&(d(),A=p[f].lineColor||v,h[h.length-
1].newStrokeStyle=A,b.strokeStyle=A,b.setLineDash&&(p[f].lineDashType?(C=p[f].lineDashType,h[h.length-1].newLineDashArray=J(C,m.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(C=m.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[f].markerSize&&(0<p[f].markerSize||0<m.markerSize)){var S=m.getMarkerProperties(f,s,n,b);g.push(S);var ea=X(u);w&&g.push({x:s,y:n,ctx:e,type:S.type,size:S.size,color:ea,borderColor:ea,borderThickness:S.borderThickness});S=m.getMarkerProperties(f,
s,r,b);g.push(S);ea=X(u);w&&g.push({x:s,y:r,ctx:e,type:S.type,size:S.size,color:ea,borderColor:ea,borderThickness:S.borderThickness})}if(p[f].indexLabel||m.indexLabel||p[f].indexLabelFormatter||m.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[f],dataSeries:m,indexKeyword:0,point:{x:s,y:r},direction:p[f].y[0]>p[f].y[1]===a.axisY.reversed?-1:1,color:x}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[f],dataSeries:m,indexKeyword:1,point:{x:s,y:n},direction:p[f].y[0]>
p[f].y[1]===a.axisY.reversed?1:-1,color:x})}else L||q||d(),L=!0;d();W.drawMarkers(g)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());
...
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,g=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var r=a.dataSeriesIndexes[h],k=this.data[r],m=k.dataPoints,g=k.id;this._eventManager.objectMap[g]={objectType:"dataSeries",dataSeriesIndex:r};g=X(g);e.fillStyle=g;var g=[],p=0,q,
f,s,n=[],ba=[];if(0<m.length){var u=k._colorSet[p%k._colorSet.length],y=k.lineColor=k.options.lineColor||u,x=y;b.fillStyle=u;b.lineWidth=k.lineThickness;var z="solid",A;if(b.setLineDash){var C=J(k.nullDataLineDashType,k.lineThickness),z=k.lineDashType;A=J(z,k.lineThickness)}for(f=!1;p<m.length;p++)if(q=m[p].x.getTime?m[p].x.getTime():m[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!f)))if(null!==m[p].y&&m[p].y.length&&"number"===typeof m[p].y[0]&&"number"===
typeof m[p].y[1]){q=a.axisX.convertValueToPixel(q);f=a.axisY.convertValueToPixel(m[p].y[0]);s=a.axisY.convertValueToPixel(m[p].y[1]);var B=k.dataPointIds[p];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:p,x1:q,y1:f,y2:s};n[n.length]={x:q,y:f};ba[ba.length]={x:q,y:s};p<m.length-1&&(x!==(m[p].lineColor||y)||z!==(m[p].lineDashType||k.lineDashType))&&(x=m[p].lineColor||y,n[n.length-1].newStrokeStyle=x,b.setLineDash&&(m[p].lineDashType?(z=m[p].lineDashType,
n[n.length-1].newLineDashArray=J(z,k.lineThickness)):(z=k.lineDashType,n[n.length-1].newLineDashArray=A)));if(0!==m[p].markerSize&&(0<m[p].markerSize||0<k.markerSize)){var G=k.getMarkerProperties(p,q,f,b);g.push(G);var L=X(B);w&&g.push({x:q,y:f,ctx:e,type:G.type,size:G.size,color:L,borderColor:L,borderThickness:G.borderThickness});G=k.getMarkerProperties(p,q,s,b);g.push(G);L=X(B);w&&g.push({x:q,y:s,ctx:e,type:G.type,size:G.size,color:L,borderColor:L,borderThickness:G.borderThickness})}if(m[p].indexLabel||
k.indexLabel||m[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[p],dataSeries:k,indexKeyword:0,point:{x:q,y:f},direction:m[p].y[0]<=m[p].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[p],dataSeries:k,indexKeyword:1,point:{x:q,y:s},direction:m[p].y[0]<=m[p].y[1]?1:-1,color:u});f=!1}else 0<p&&!f&&(k.connectNullData?b.setLineDash&&(0<n.length&&(k.options.nullDataLineDashType||!m[p-1].lineDashType))&&(n[n.length-
1].newLineDashArray=C,z=k.nullDataLineDashType):(d(A,y),n=[],ba=[])),f=!0;d(A,y);W.drawMarkers(g)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),
this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,g=this.plotArea,l=0,h,r,k,m,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l=this.options.dataPointMinWidth?this.dataPointMinWidth:
...
l>r&&(l=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,r));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&r<l)&&(r=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>r&&(q=r);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(g.x1,g.y1,g.width,g.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(g.x1,g.y1,g.width,g.height),this._eventManager.ghostCtx.clip());for(var f=0;f<a.dataSeriesIndexes.length;f++){var s=
a.dataSeriesIndexes[f],n=this.data[s],v=n.dataPoints,e=n._colorSet[0];n.risingColor=n.options.risingColor?n.options.risingColor:e;n.fallingColor=n.options.fallingColor?n.options.fallingColor:"#e40a0a";var u="number"===typeof n.options.lineThickness?Math.round(n.lineThickness):1,y=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var x=5<q&&n.bevelEnabled?!0:!1,z=!1,A=null,C=null,l=0;l<v.length;l++)if(v[l].getTime?m=v[l].x.getTime():m=v[l].x,"number"!==typeof v[l].y){if(0<l&&!z&&n.connectNullData)var B=
...
0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(g.x1,g.y1,g.width,g.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,
animationBase:0}}};var pa=function(a,d,c,b,e,g,l,h,r){if(!(0>c)){"undefined"===typeof h&&(h=1);if(!w){var k=Number((l%(2*Math.PI)).toFixed(8));Number((g%(2*Math.PI)).toFixed(8))===k&&(l-=1E-4)}a.save();a.globalAlpha=h;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,g,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,g,l,!1),0<=r&&a.arc(d.x,d.y,r*c,l,g,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=
2,a.fill());a.globalAlpha=1;a.restore()}};n.prototype.renderPie=function(a){function d(){if(k&&m){for(var a=0,b=0,c=0,d=0,e=0;e<m.length;e++){var g=m[e],l=k.dataPointIds[e];f[e].id=l;f[e].objectType="dataPoint";f[e].dataPointIndex=e;f[e].dataSeriesIndex=0;var h=f[e],p={percent:null,total:null},t=null,p=n.getPercentAndTotal(k,g);if(k.indexLabelFormatter||g.indexLabelFormatter)t={chart:n.options,dataSeries:k,dataPoint:g,total:p.total,percent:p.percent};p=g.indexLabelFormatter?g.indexLabelFormatter(t):
g.indexLabel?n.replaceKeywordsWithValue(g.indexLabel,g,k,e):k.indexLabelFormatter?k.indexLabelFormatter(t):k.indexLabel?n.replaceKeywordsWithValue(k.indexLabel,g,k,e):g.label?g.label:"";n._eventManager.objectMap[l]=h;h.center={x:x.x,y:x.y};h.y=g.y;h.radius=C;h.percentInnerRadius=E;h.indexLabelText=p;h.indexLabelPlacement=k.indexLabelPlacement;h.indexLabelLineColor=g.indexLabelLineColor?g.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:g.color?g.color:k._colorSet[e%
k._colorSet.length];h.indexLabelLineThickness=r(g.indexLabelLineThickness)?k.indexLabelLineThickness:g.indexLabelLineThickness;h.indexLabelLineDashType=g.indexLabelLineDashType?g.indexLabelLineDashType:k.indexLabelLineDashType;h.indexLabelFontColor=g.indexLabelFontColor?g.indexLabelFontColor:k.indexLabelFontColor;h.indexLabelFontStyle=g.indexLabelFontStyle?g.indexLabelFontStyle:k.indexLabelFontStyle;h.indexLabelFontWeight=g.indexLabelFontWeight?g.indexLabelFontWeight:k.indexLabelFontWeight;h.indexLabelFontSize=
r(g.indexLabelFontSize)?k.indexLabelFontSize:g.indexLabelFontSize;h.indexLabelFontFamily=g.indexLabelFontFamily?g.indexLabelFontFamily:k.indexLabelFontFamily;h.indexLabelBackgroundColor=g.indexLabelBackgroundColor?g.indexLabelBackgroundColor:k.options.indexLabelBackgroundColor?k.options.indexLabelBackgroundColor:k.indexLabelBackgroundColor;h.indexLabelMaxWidth=g.indexLabelMaxWidth?g.indexLabelMaxWidth:k.indexLabelMaxWidth?k.indexLabelMaxWidth:0.33*q.width;h.indexLabelWrap="undefined"!==typeof g.indexLabelWrap?
g.indexLabelWrap:k.indexLabelWrap;h.indexLabelTextAlign=g.indexLabelTextAlign?g.indexLabelTextAlign:k.indexLabelTextAlign?k.indexLabelTextAlign:"left";h.startAngle=0===e?k.startAngle?k.startAngle/180*Math.PI:0:f[e-1].endAngle;h.startAngle=(h.startAngle+2*Math.PI)%(2*Math.PI);h.endAngle=h.startAngle+2*Math.PI/z*Math.abs(g.y);g=(h.endAngle+h.startAngle)/2;g=(g+2*Math.PI)%(2*Math.PI);h.midAngle=g;if(h.midAngle>Math.PI/2-u&&h.midAngle<Math.PI/2+u){if(0===a||f[c].midAngle>h.midAngle)c=e;a++}else if(h.midAngle>
3*Math.PI/2-u&&h.midAngle<3*Math.PI/2+u){if(0===b||f[d].midAngle>h.midAngle)d=e;b++}h.hemisphere=g>Math.PI/2&&g<=3*Math.PI/2?"left":"right";h.indexLabelTextBlock=new ja(n.plotArea.ctx,{fontSize:h.indexLabelFontSize,fontFamily:h.indexLabelFontFamily,fontColor:h.indexLabelFontColor,fontStyle:h.indexLabelFontStyle,fontWeight:h.indexLabelFontWeight,textAlign:h.indexLabelTextAlign,backgroundColor:h.indexLabelBackgroundColor,maxWidth:h.indexLabelMaxWidth,maxHeight:h.indexLabelWrap?5*h.indexLabelFontSize:
1.5*h.indexLabelFontSize,text:h.indexLabelText,padding:0,textBaseline:"top"});h.indexLabelTextBlock.measureText()}l=g=0;p=!1;for(e=0;e<m.length;e++)h=f[(c+e)%m.length],1<a&&(h.midAngle>Math.PI/2-u&&h.midAngle<Math.PI/2+u)&&(g<=a/2&&!p?(h.hemisphere="right",g++):(h.hemisphere="left",p=!0));p=!1;for(e=0;e<m.length;e++)h=f[(d+e)%m.length],1<b&&(h.midAngle>3*Math.PI/2-u&&h.midAngle<3*Math.PI/2+u)&&(l<=b/2&&!p?(h.hemisphere="left",l++):(h.hemisphere="right",p=!0))}}function c(a){var b=n.plotArea.ctx;b.clearRect(q.x1,
q.y1,q.width,q.height);b.fillStyle=n.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(b=0;b<m.length;b++){var c=f[b].startAngle,d=f[b].endAngle;if(d>c){var e=0.07*C*Math.cos(f[b].midAngle),g=0.07*C*Math.sin(f[b].midAngle),l=!1;if(m[b].exploded){if(1E-9<Math.abs(f[b].center.x-(x.x+e))||1E-9<Math.abs(f[b].center.y-(x.y+g)))f[b].center.x=x.x+e*a,f[b].center.y=x.y+g*a,l=!0}else if(0<Math.abs(f[b].center.x-x.x)||0<Math.abs(f[b].center.y-x.y))f[b].center.x=x.x+e*(1-a),f[b].center.y=x.y+g*(1-a),
l=!0;l&&(e={},e.dataSeries=k,e.dataPoint=k.dataPoints[b],e.index=b,n.toolTip.highlightObjects([e]));pa(n.plotArea.ctx,f[b].center,f[b].radius,m[b].color?m[b].color:k._colorSet[b%k._colorSet.length],k.type,c,d,k.fillOpacity,f[b].percentInnerRadius)}}a=n.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin="round";for(b=b=0;b<m.length;b++)c=f[b],c.indexLabelText&&(c.indexLabelTextBlock.y-=c.indexLabelTextBlock.height/2,d=0,d="left"===c.hemisphere?"inside"!==
...
k=x.y-1*w,h=x.y+1*w;if(0<=a&&a<m.length){var p=f[a];if(0>c&&p.indexLabelTextBlock.y<k||0<c&&p.indexLabelTextBlock.y>h)return 0;var q=0,t=0,t=q=q=0;0>c?p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2>k&&p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2+c<k&&(c=-(k-(p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2+c))):p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2<k&&p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c>h&&(c=p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/
2+c-h);c=p.indexLabelTextBlock.y+c;k=0;k="right"===p.hemisphere?x.x+Math.sqrt(Math.pow(w,2)-Math.pow(c-x.y,2)):x.x-Math.sqrt(Math.pow(w,2)-Math.pow(c-x.y,2));t=x.x+C*Math.cos(p.midAngle);q=x.y+C*Math.sin(p.midAngle);q=Math.sqrt(Math.pow(k-t,2)+Math.pow(c-q,2));t=Math.acos(C/w);q=Math.acos((w*w+C*C-q*q)/(2*C*w));c=q<t?c-p.indexLabelTextBlock.y:0;k=null;for(h=1;h<m.length;h++)if(k=(a-h+f.length)%f.length,f[k].hemisphere!==f[a].hemisphere){k=null;break}else if(f[k].indexLabelText&&f[k].hemisphere===
f[a].hemisphere&&k!==a&&(0>b(f[k],f[a])||("right"===f[a].hemisphere?f[k].indexLabelTextBlock.y<=f[a].indexLabelTextBlock.y:f[k].indexLabelTextBlock.y>=f[a].indexLabelTextBlock.y)))break;else k=null;t=k;q=e(a);h=k=0;0>c?(h="right"===p.hemisphere?t:q,l=c,null!==h&&(t=-c,c=p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2-(f[h].indexLabelTextBlock.y+f[h].indexLabelTextBlock.height/2),c-t<s&&(k=-t,h=g(h,k,d+1),+h.toFixed(y)>+k.toFixed(y)&&(l=c>s?-(c-s):-(t-(h-k)))))):0<c&&(h="right"===p.hemisphere?
q:t,l=c,null!==h&&(t=c,c=f[h].indexLabelTextBlock.y-f[h].indexLabelTextBlock.height/2-(p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2),c-t<s&&(k=t,h=g(h,k,d+1),+h.toFixed(y)<+k.toFixed(y)&&(l=c>s?c-s:t-(k-h)))));l&&(d=p.indexLabelTextBlock.y+l,c=0,c="right"===p.hemisphere?x.x+Math.sqrt(Math.pow(w,2)-Math.pow(d-x.y,2)):x.x-Math.sqrt(Math.pow(w,2)-Math.pow(d-x.y,2)),p.midAngle>Math.PI/2-u&&p.midAngle<Math.PI/2+u?(k=(a-1+f.length)%f.length,k=f[k],a=f[(a+1+f.length)%f.length],"left"===p.hemisphere&&
"right"===k.hemisphere&&c>k.indexLabelTextBlock.x?c=k.indexLabelTextBlock.x-15:"right"===p.hemisphere&&("left"===a.hemisphere&&c<a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x+15)):p.midAngle>3*Math.PI/2-u&&p.midAngle<3*Math.PI/2+u&&(k=(a-1+f.length)%f.length,k=f[k],a=f[(a+1+f.length)%f.length],"right"===p.hemisphere&&"left"===k.hemisphere&&c<k.indexLabelTextBlock.x?c=k.indexLabelTextBlock.x+15:"left"===p.hemisphere&&("right"===a.hemisphere&&c>a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x-
...
f[a];h.indexLabelTextBlock.x=x.x+w*Math.cos(h.midAngle);h.indexLabelTextBlock.y=x.y+w*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=C;h.percentInnerRadius=E}for(var t,r,a=0;a<m.length;a++){var h=f[a],u=e(a);if(null!==u){t=f[a];r=f[u];var z=0,z=b(t,r)-s;if(0>z){for(var A=r=0,H=0;H<m.length;H++)H!==a&&f[H].hemisphere===h.hemisphere&&(f[H].indexLabelTextBlock.y<h.indexLabelTextBlock.y?r++:A++);r=z/(r+A||1)*A;var A=-1*(z-r),J=H=0;"right"===h.hemisphere?(H=g(a,r),A=-1*(z-H),J=g(u,A),+J.toFixed(y)<
+A.toFixed(y)&&+H.toFixed(y)<=+r.toFixed(y)&&g(a,-(A-J))):(H=g(u,r),A=-1*(z-H),J=g(a,A),+J.toFixed(y)<+A.toFixed(y)&&+H.toFixed(y)<=+r.toFixed(y)&&g(u,-(A-J)))}}}}else for(a=0;a<m.length;a++)h=f[a],w="pie"===k.type?0.7*C:0.85*C,u=x.x+w*Math.cos(h.midAngle),r=x.y+w*Math.sin(h.midAngle),h.indexLabelTextBlock.x=u,h.indexLabelTextBlock.y=r;for(a=0;a<m.length;a++)if(h=f[a],u=h.indexLabelTextBlock.measureText(),0!==u.height&&0!==u.width)u=u=0,"right"===h.hemisphere?(u=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+
...
2-x.y)<C)&&(u/=Math.abs(Math.cos(h.indexLabelAngle)),9<u&&(u*=0.3),u>d&&(d=u)),u=u=0,0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?(u=q.y2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+5),u*=-1):u=q.y1-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-5),0<u&&(!l&&h.indexLabelText&&(r=0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?-1:1,0===g(a,u*r)&&g(a,2*r)),Math.abs(h.indexLabelTextBlock.x-x.x)<C&&(u/=Math.abs(Math.sin(h.indexLabelAngle)),9<u&&(u*=0.3),u>d&&(d=u)));var G=function(a,
b,c){for(var d=[],e=0;d.push(f[b]),b!==c;b=(b+1+m.length)%m.length);d.sort(function(a,b){return a.y-b.y});for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,g=!1,k=0;k<m.length;k++)if(g=!1,t=f[k],t.indexLabelText){var l=e(k);if(null!==l){var h=f[l];z=0;z=b(t,h);var q;if(q=0>z){q=t.indexLabelTextBlock.x;var n=t.indexLabelTextBlock.y-t.indexLabelTextBlock.height/
2,s=t.indexLabelTextBlock.y+t.indexLabelTextBlock.height/2,r=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2,u=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,D=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=t.indexLabelTextBlock.x+t.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>u+p||n>D+p||s<r-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-z),0===k%Math.max(m.length/10,3)&&(g=!0)):g=!0;g&&(0<d&&0<=a&&0<=c)&&(G(d,a,c),c=a=-1,d=0)}}0<d&&G(d,a,c)})()}}function h(){n.plotArea.layoutManager.reset();
...
b.label:"";0>=m&&(m=0);1E3>t&&1E3-t<s&&(t+=1E3-t);P.roundRect||Da(P);c=new ja(P,{fontSize:g,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:n,backgroundColor:d,maxWidth:t,maxHeight:!1===x[C]?q?4.28571429*g:1.5*g:x[C],text:b,padding:da});c.measureText();I.push({textBlock:c,id:u.reversed?B:C,isDirty:!1,lineColor:a,lineThickness:m,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=
...
I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,u.reversed?(I[l].textBlock.y+I[l].height>U+z&&(I[l].textBlock.y=U+z-I[l].height),I[l].textBlock.y<ta-z&&(I[l].textBlock.y=ta-z)):(I[l].textBlock.y<U-z&&(I[l].textBlock.y=U-z),I[l].textBlock.y+I[l].height>ta+z&&(I[l].textBlock.y=ta+z-I[l].height))}function g(){var a,b,
c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<R.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=R[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>Ca?f(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<Ca?f(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+X,I[e].textBlock.y=c-I[e].height/2,u.reversed?(I[e].textBlock.y+I[e].height>U+z&&(I[e].textBlock.y=U+z-I[e].height),I[e].textBlock.y<ta-z&&(I[e].textBlock.y=
...
else{var n="#,##0.",k=Math.max(Math.ceil(Math.log(1/Math.abs(l))/Math.LN10),2);if(isNaN(k)||!isFinite(k))k=2;for(var m=0;m<k;m++)n+="#";c.percentFormatString=n}a=a.replace("#percent",da(l,n,g._cultureInfo));a=a.replace("#total",da(h,c.yValueFormatString?c.yValueFormatString:"#,##0.########",g._cultureInfo))}while(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))}return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,function(a){if('"'===a[0]&&'"'===a[a.length-1]||"'"===a[0]&&"'"===a[a.length-1])return a.slice(1,
a.length-1);a=Ha(a.slice(1,a.length-1));a=a.replace("#index",e);var l=null;try{var f=a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);f&&0<f.length&&(l=Ha(f[2]),a=Ha(f[1]))}catch(k){}f=null;if("color"===a)return"waterfall"===c.type?d.color?d.color:0<d.y?c.risingColor:c.fallingColor:"error"===c.type?c.color?c.color:c._colorSet[l%c._colorSet.length]:d.color?d.color:c.color?c.color:c._colorSet[b%c._colorSet.length];if(d.hasOwnProperty(a))f=d;else if(c.hasOwnProperty(a))f=c;else return"";f=f[a];null!==l&&(f=f[l]);
return"x"===a?(c.axisX&&"dateTime"===c.axisX.valueType||"dateTime"===c.xValueType||d.x&&d.x.getTime)&&!c.axisX.logarithmic?Ba(f,d.xValueFormatString?d.xValueFormatString:c.xValueFormatString?c.xValueFormatString:c.xValueFormatString=g.axisX&&g.axisX.autoValueFormatString?g.axisX.autoValueFormatString:"DD MMM YY",g._cultureInfo):da(f,d.xValueFormatString?d.xValueFormatString:c.xValueFormatString?c.xValueFormatString:c.xValueFormatString="#,##0.########",g._cultureInfo):"y"===a?da(f,d.yValueFormatString?
d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",g._cultureInfo):"z"===a?da(f,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",g._cultureInfo):f})};oa(K,G);K.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,g=0,l=0,h=this.markerMargin=this.chart.options.legend&&!r(this.chart.options.legend.markerMargin)?
this.chart.options.legend.markerMargin:0.3*this.fontSize;this.height=0;var n=[],k=[];if("top"===this.verticalAlign||"bottom"===this.verticalAlign)this.orientation="horizontal",c=this.verticalAlign,g=this.maxWidth=null!==this.maxWidth?this.maxWidth:d.width,l=this.maxHeight=null!==this.maxHeight?this.maxHeight:0.5*d.height;else if("center"===this.verticalAlign){this.orientation="vertical";if("left"===this.horizontalAlign||"center"===this.horizontalAlign||"right"===this.horizontalAlign)c=this.horizontalAlign;
g=this.maxWidth=null!==this.maxWidth?this.maxWidth:0.5*d.width;l=this.maxHeight=null!==this.maxHeight?this.maxHeight:d.height}this.errorMarkerColor=[];for(var m=0;m<this.dataSeries.length;m++){var p=this.dataSeries[m];if(p.dataPoints&&p.dataPoints.length)if("pie"!==p.type&&"doughnut"!==p.type&&"funnel"!==p.type&&"pyramid"!==p.type){var q=p.legendMarkerType=p.legendMarkerType?p.legendMarkerType:"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type&&"scatter"!==p.type&&"bubble"!==p.type||!p.markerType?
"error"===p.type&&p._linkedSeries?p._linkedSeries.legendMarkerType?p._linkedSeries.legendMarkerType:Q.getDefaultLegendMarker(p._linkedSeries.type):Q.getDefaultLegendMarker(p.type):p.markerType,f=p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:null}):p.name,s=p.legendMarkerColor=p.legendMarkerColor?p.legendMarkerColor:p.markerColor?p.markerColor:"error"===p.type?r(p.whiskerColor)?p._colorSet[0]:p.whiskerColor:p._colorSet[0],
w=p.markerSize||"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type?0.75*this.lineHeight:0,v=p.legendMarkerBorderColor?p.legendMarkerBorderColor:p.markerBorderColor,u=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0;"error"===p.type&&this.errorMarkerColor.push(s);f=this.chart.replaceKeywordsWithValue(f,p.dataPoints[0],p,m);q={markerType:q,markerColor:s,text:f,textBlock:null,chartType:p.type,markerSize:w,lineColor:p._colorSet[0],
dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:v,markerBorderThickness:u};n.push(q)}else for(var y=0;y<p.dataPoints.length;y++){var x=p.dataPoints[y],q=x.legendMarkerType?x.legendMarkerType:p.legendMarkerType?p.legendMarkerType:Q.getDefaultLegendMarker(p.type),f=x.legendText?x.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:x}):x.name?x.name:"DataPoint: "+(y+1),s=x.legendMarkerColor?x.legendMarkerColor:
p.legendMarkerColor?p.legendMarkerColor:x.color?x.color:p.color?p.color:p._colorSet[y%p._colorSet.length],w=0.75*this.lineHeight,v=x.legendMarkerBorderColor?x.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:x.markerBorderColor?x.markerBorderColor:p.markerBorderColor,u=x.legendMarkerBorderThickness?x.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:x.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0,f=this.chart.replaceKeywordsWithValue(f,
x,p,y),q={markerType:q,markerColor:s,text:f,textBlock:null,chartType:p.type,markerSize:w,dataSeriesIndex:m,dataPointIndex:y,markerBorderColor:v,markerBorderThickness:u};(x.showInLegend||p.showInLegend&&!1!==x.showInLegend)&&n.push(q)}}!0===this.reversed&&n.reverse();if(0<n.length){p=null;s=f=x=y=0;x=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,g):this.itemMaxWidth=Math.min(this.itemWidth,g):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,g):this.itemMaxWidth=
...
fontStyle:this.fontStyle,textBaseline:"middle"});q.textBlock.measureText();null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(w+h+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0)));if(!p||p.width+Math.round(q.textBlock.width+w+h+(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))>g)p={items:[],width:0},k.push(p),this.height+=f,f=0;f=Math.max(f,q.textBlock.height)}else q.textBlock=
...
!1===this.itemWrap?k.length*this.lineHeight:this.height+f;this.height=Math.min(l,this.height);this.width=Math.min(g,this.width)}"top"===this.verticalAlign?(e="left"===this.horizontalAlign?d.x1:"right"===this.horizontalAlign?d.x2-this.width:d.x1+d.width/2-this.width/2,b=d.y1):"center"===this.verticalAlign?(e="left"===this.horizontalAlign?d.x1:"right"===this.horizontalAlign?d.x2-this.width:d.x1+d.width/2-this.width/2,b=d.y1+d.height/2-this.height/2):"bottom"===this.verticalAlign&&(e="left"===this.horizontalAlign?
...
this.width,y2:b+this.height}};K.prototype.render=function(){var a=this.bounds.x1,d=this.bounds.y1,c=this.markerMargin,b=this.maxWidth,e=this.maxHeight,g=this.markerSize,l=this.rows;(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(a,d,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);for(var h=0,n=0;n<l.length;n++){for(var k=l[n],m=0,p=0;p<k.items.length;p++){var q=k.items[p],f=q.textBlock.x+a+(0===p?0.2*g:this.horizontalSpacing),
s=d+h,r=f;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(a,d,b,Math.max(e-e%this.lineHeight,0));this.ctx.clip();if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)this.ctx.strokeStyle=q.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/8),this.ctx.beginPath(),this.ctx.moveTo(f-0.1*this.lineHeight,s+this.lineHeight/2),this.ctx.lineTo(f+0.85*this.lineHeight,s+this.lineHeight/2),this.ctx.stroke(),r-=
0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=g/8;this.ctx.beginPath();var w=f-0.08*this.lineHeight+0.1*this.lineHeight,u=s+0.15*this.lineHeight,y=0.7*this.lineHeight,x=y+0.02*this.lineHeight;this.ctx.moveTo(w,u);this.ctx.lineTo(w+y,u);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w+y/2,u);this.ctx.lineTo(w+y/2,u+x);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w,u+x);this.ctx.lineTo(w+y,u+x);this.ctx.stroke();this.errorMarkerColor.shift()}W.drawMarker(f+
g/2,s+this.lineHeight/2,this.ctx,q.markerType,"error"===q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);q.textBlock.x=f+c+g;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(s+this.lineHeight/2);q.textBlock.render(!0);this.ctx.restore();m=0<p?Math.max(m,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||
(this.ctx.globalAlpha=1);f=X(q.id);this.ghostCtx.fillStyle=f;this.ghostCtx.beginPath();this.ghostCtx.fillRect(r,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-r,q.textBlock.height);q.x1=this.chart._eventManager.objectMap[q.id].x1=r;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/
...
index:NaN},b=null,e=0,g=0,l=1,h=Infinity,n=0,k=0,m=0;"none"!==this.chart.plotInfo.axisPlacement&&(this.axisX.logarithmic?(m=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),m=1<m?Math.min(Math.max((this.dataPoints.length-1)/m*Math.log(a/this.dataPoints[0].x)>>0,0),this.dataPoints.length):0):(m=this.dataPoints[this.dataPoints.length-1].x-this.dataPoints[0].x,m=0<m?Math.min(Math.max((this.dataPoints.length-1)/m*(a-this.dataPoints[0].x)>>0,0),this.dataPoints.length):0));for(;;){g=
0<l?m+e:m-e;if(0<=g&&g<this.dataPoints.length){var b=this.dataPoints[g],p=this.axisX.logarithmic?b.x>a?b.x/a:a/b.x:Math.abs(b.x-a);p<c.distance&&(c.dataPoint=b,c.distance=p,c.index=g);b=p;b<=h?h=b:0<l?n++:k++;if(1E3<n&&1E3<k)break}else if(0>m-e&&m+e>=this.dataPoints.length)break;-1===l?(e++,l=1):l=-1}return d||(c.dataPoint.x.getTime?c.dataPoint.x.getTime():c.dataPoint.x)!==(a.getTime?a.getTime():a)?d&&null!==c.dataPoint?c:null:c};Q.prototype.getDataPointAtXY=function(a,d,c){if(!this.dataPoints||0===
this.dataPoints.length||a<this.chart.plotArea.x1||a>this.chart.plotArea.x2||d<this.chart.plotArea.y1||d>this.chart.plotArea.y2)return null;c=c||!1;var b=[],e=0,g=0,l=1,h=!1,n=Infinity,k=0,m=0,p=0;if("none"!==this.chart.plotInfo.axisPlacement)if(p=(this.chart.axisX[0]?this.chart.axisX[0]:this.chart.axisX2[0]).getXValueAt({x:a,y:d}),this.axisX.logarithmic)var q=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),p=1<q?Math.min(Math.max((this.dataPoints.length-1)/q*Math.log(p/
this.dataPoints[0].x)>>0,0),this.dataPoints.length):0;else q=this.dataPoints[this.dataPoints.length-1].x-this.dataPoints[0].x,p=0<q?Math.min(Math.max((this.dataPoints.length-1)/q*(p-this.dataPoints[0].x)>>0,0),this.dataPoints.length):0;for(;;){g=0<l?p+e:p-e;if(0<=g&&g<this.dataPoints.length){var q=this.chart._eventManager.objectMap[this.dataPointIds[g]],f=this.dataPoints[g],s=null;if(q){switch(this.type){case "column":case "stackedColumn":case "stackedColumn100":case "bar":case "stackedBar":case "stackedBar100":case "rangeColumn":case "rangeBar":case "waterfall":case "error":a>=
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:f,dataPointIndex:g,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),h=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var r=ma("markerSize",f,this)||4,w=c?20:r,s=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));s<=w&&b.push({dataPoint:f,dataPointIndex:g,dataSeries:this,distance:s});q=
Math.abs(q.x1-a);q<=n?n=q:0<l?k++:m++;s<=r/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":r=ma("markerSize",f,this)||4;w=c?20:r;s=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));s<=w&&b.push({dataPoint:f,dataPointIndex:g,dataSeries:this,distance:s});q=Math.abs(q.x1-a);q<=n?n=q:0<l?k++:m++;s<=r/2&&(h=!0);break;case "bubble":r=q.size;s=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));s<=r/2&&(b.push({dataPoint:f,dataPointIndex:g,dataSeries:this,
distance:s}),h=!0);break;case "pie":case "doughnut":r=q.center;w="doughnut"===this.type?q.percentInnerRadius*q.radius:0;s=Math.sqrt(Math.pow(r.x-a,2)+Math.pow(r.y-d,2));s<q.radius&&s>w&&(s=Math.atan2(d-r.y,a-r.x),0>s&&(s+=2*Math.PI),s=Number(((180*(s/Math.PI)%360+360)%360).toFixed(12)),r=Number(((180*(q.startAngle/Math.PI)%360+360)%360).toFixed(12)),w=Number(((180*(q.endAngle/Math.PI)%360+360)%360).toFixed(12)),0===w&&1<q.endAngle&&(w=360),r>=w&&0!==f.y&&(w+=360,s<r&&(s+=360)),s>r&&s<w&&(b.push({dataPoint:f,
dataPointIndex:g,dataSeries:this,distance:0}),h=!0));break;case "funnel":case "pyramid":s=q.funnelSection;d>s.y1&&d<s.y4&&(s.y6?d>s.y6?(g=s.x6+(s.x5-s.x6)/(s.y5-s.y6)*(d-s.y6),s=s.x3+(s.x4-s.x3)/(s.y4-s.y3)*(d-s.y3)):(g=s.x1+(s.x6-s.x1)/(s.y6-s.y1)*(d-s.y1),s=s.x2+(s.x3-s.x2)/(s.y3-s.y2)*(d-s.y2)):(g=s.x1+(s.x4-s.x1)/(s.y4-s.y1)*(d-s.y1),s=s.x2+(s.x3-s.x2)/(s.y3-s.y2)*(d-s.y2)),a>g&&a<s&&(b.push({dataPoint:f,dataPointIndex:q.dataPointIndex,dataSeries:this,distance:0}),h=!0));break;case "boxAndWhisker":if(a>=
...
this.logarithmic&&this.equidistantInterval?c*Math.pow(this.logarithmBase,this.interval):c+this.interval:(this.logarithmic&&this.equidistantInterval?c*Math.pow(this.logarithmBase,this.interval):c+this.interval).toFixed(12))){for(;f<p.length&&c>p[f].endValue;f++);a=f<p.length&&c>=p[f].startValue&&c<=p[f].endValue;m=c;a||(a=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.options,value:m,label:this.labels[m]?this.labels[m]:null}):"axisX"===this.type&&this.labels[m]?this.labels[m]:
da(m,this.valueFormatString,this.chart._cultureInfo),a=new ja(this.ctx,{x:0,y:0,maxWidth:g,maxHeight:l,angle:this.labelAngle,text:this.prefix+a+this.suffix,textAlign:this.labelTextAlign,backgroundColor:this.labelBackgroundColor,borderColor:this.labelBorderColor,borderThickness:this.labelBorderThickness,cornerRadius:this.labelCornerRadius,fontSize:this.labelFontSize,fontFamily:this.labelFontFamily,fontWeight:this.labelFontWeight,fontColor:this.labelFontColor,fontStyle:this.labelFontStyle,textBaseline:"middle"}),
this._labels.push({position:m,textBlock:a,effectiveHeight:null}))}}else for(this.intervalStartPosition=this.getLabelStartPoint(new Date(this.viewportMinimum),this.intervalType,this.interval),e=Xa(new Date(this.viewportMaximum),this.interval,this.intervalType),f=q,c=this.intervalStartPosition;c<e;Xa(c,b,this.intervalType)){for(a=c.getTime();f<p.length&&a>p[f].endValue;f++);m=a;a=f<p.length&&a>=p[f].startValue&&a<=p[f].endValue;a||(a=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.options,
...
Math.log(this.range):this.lineCoordinates.width/(this.logarithmic&&this.equidistantInterval?Math.log(this.range)/Math.log(this.logarithmBase):Math.abs(this.range))*T[this.intervalType+"Duration"]*this.interval,g="undefined"===typeof this.options.labelMaxWidth?0.5*this.chart.width>>0:this.options.labelMaxWidth,this.chart.panEnabled||(l="undefined"===typeof this.options.labelWrap||this.labelWrap?0.8*this.chart.height>>0:1.5*this.labelFontSize);else if("left"===this._position||"right"===this._position)h=
this.logarithmic&&!this.equidistantInterval&&2<=this._labels.length?this.lineCoordinates.height*Math.log(Math.min(this._labels[this._labels.length-1].position/this._labels[this._labels.length-2].position,this._labels[1].position/this._labels[0].position))/Math.log(this.range):this.lineCoordinates.height/(this.logarithmic&&this.equidistantInterval?Math.log(this.range)/Math.log(this.logarithmBase):Math.abs(this.range))*T[this.intervalType+"Duration"]*this.interval,this.chart.panEnabled||(g="undefined"===
typeof this.options.labelMaxWidth?0.3*this.chart.width>>0:this.options.labelMaxWidth),l="undefined"===typeof this.options.labelWrap||this.labelWrap?0.3*this.chart.height>>0:1.5*this.labelFontSize;for(b=0;b<this._labels.length;b++){a=this._labels[b].textBlock;a.maxWidth=g;a.maxHeight=l;var s=a.measureText();n=s.height}e=[];q=p=0;if(this.labelAutoFit||this.options.labelAutoFit)if(r(this.labelAngle)||(this.labelAngle=(this.labelAngle%360+360)%360,90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=
180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360)),"bottom"===this._position||"top"===this._position)if(g=0.9*h>>0,q=0,!this.chart.panEnabled&&1<=this._labels.length){this.sessionVariables.labelFontSize=this.labelFontSize;this.sessionVariables.labelMaxWidth=g;this.sessionVariables.labelMaxHeight=l;this.sessionVariables.labelAngle=this.labelAngle;this.sessionVariables.labelWrap=this.labelWrap;for(c=0;c<this._labels.length;c++)if(!this._labels[c].breaksLabelType){a=this._labels[c].textBlock;
...
Math.max.apply(Math,e);Math.cos(Math.PI/180*Math.abs(this.labelAngle));Math.sin(Math.PI/180*Math.abs(this.labelAngle));b=g*Math.sin(Math.PI/180*Math.abs(this.labelAngle))+(l-a.fontSize/2)*Math.cos(Math.PI/180*Math.abs(this.labelAngle));if(r(this.options.labelAngle)&&isNaN(this.options.labelAngle)&&0!==this.options.labelAngle)if(this.sessionVariables.labelMaxHeight=0===this.labelAngle?l:Math.min((b-g*Math.cos(Math.PI/180*Math.abs(this.labelAngle)))/Math.sin(Math.PI/180*Math.abs(this.labelAngle)),b),
m=(k-(n+a.fontSize/2)*Math.cos(Math.PI/180*Math.abs(-25)))/Math.sin(Math.PI/180*Math.abs(-25)),!r(this.options.labelWrap))this.labelWrap?r(this.options.labelMaxWidth)?(this.sessionVariables.labelMaxWidth=Math.min(Math.max(g,q),m),this.sessionVariables.labelWrap=this.labelWrap,d&&s.width+d.width>>0>2*g&&(this.sessionVariables.labelAngle=-25)):(this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>
g?-25:this.sessionVariables.labelAngle):r(this.options.labelMaxWidth)?(this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelMaxWidth=g,d&&s.width+d.width>>0>2*g&&(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=m)):(this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>g?-25:this.sessionVariables.labelAngle,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=
l,this.sessionVariables.labelWrap=this.labelWrap);else{if(r(this.options.labelWrap))if(!r(this.options.labelMaxWidth))this.options.labelMaxWidth<g?(this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=b):(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=l);else if(!r(d))if(b=s.width+d.width>>0,f=this.labelFontSize,q<g)b-2*g>p&&(p=b-2*g,b>=2*g&&b<2.2*g?(this.sessionVariables.labelMaxWidth=
...
r(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=m):b>5*g&&(this.sessionVariables.labelWrap=!0,this.sessionVariables.labelMaxWidth=g,this.sessionVariables.labelFontSize=f,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelAngle=this.labelAngle));else if(v===c&&(0===v&&q+this._labels[v+1].textBlock.measureText().width-2*g>p||v===this._labels.length-1&&q+this._labels[v-
...
m;else if(0===p)for(this.sessionVariables.labelFontSize=r(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelWrap=!0,b=0;b<this._labels.length;b++)a=this._labels[b].textBlock,a.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(g,q),m),s=a.measureText(),b<this._labels.length-1&&(f=b+1,d=this._labels[f].textBlock,d.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(g,q),m),d=d.measureText(),s.width+d.width>>0>2*g&&(this.sessionVariables.labelAngle=
-25))}else(this.sessionVariables.labelAngle=this.labelAngle,this.sessionVariables.labelMaxHeight=0===this.labelAngle?l:Math.min((b-g*Math.cos(Math.PI/180*Math.abs(this.labelAngle)))/Math.sin(Math.PI/180*Math.abs(this.labelAngle)),b),m=0!=this.labelAngle?(k-(n+a.fontSize/2)*Math.cos(Math.PI/180*Math.abs(this.labelAngle)))/Math.sin(Math.PI/180*Math.abs(this.labelAngle)):g,this.sessionVariables.labelMaxHeight=this.labelWrap?(k-m*Math.sin(Math.PI/180*Math.abs(this.labelAngle)))/Math.cos(Math.PI/180*Math.abs(this.labelAngle)):
...
this.options.labelWrap,a.maxHeight=r(this.sessionVariables.labelMaxHeight)?this.sessionVariables.labelMaxHeight=l:this.sessionVariables.labelMaxHeight,a.measureText();else if("left"===this._position||"right"===this._position)if(g=r(this.options.labelMaxWidth)?0.3*this.chart.width>>0:this.options.labelMaxWidth,l="undefined"===typeof this.options.labelWrap||this.labelWrap?0.3*this.chart.height>>0:1.5*this.labelFontSize,!this.chart.panEnabled&&1<=this._labels.length){this.sessionVariables.labelFontSize=
this.labelFontSize;this.sessionVariables.labelMaxWidth=g;this.sessionVariables.labelMaxHeight=l;this.sessionVariables.labelAngle=r(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle;this.sessionVariables.labelWrap=this.labelWrap;for(c=0;c<this._labels.length;c++)if(!this._labels[c].breaksLabelType){a=this._labels[c].textBlock;s=a.measureText();for(f=c+1;f<this._labels.length;f++)if(!this._labels[f].breaksLabelType){d=this._labels[f].textBlock;d=d.measureText();break}e.push(a.height);
...
l&&h<10*l?(r(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=r(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize,this.sessionVariables.labelMaxWidth=g,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelAngle=r(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle):h>10*l&&h<50*l&&(r(this.options.labelFontSize)&&12<this.labelFontSize&&
(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=r(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelMaxWidth=g,this.sessionVariables.labelAngle=r(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle))):(this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth?this.options.labelMaxWidth:this.sessionVariables.labelMaxWidth)):
(this.sessionVariables.labelMaxWidth=this.labelWrap?this.options.labelMaxWidth?this.options.labelMaxWidth:this.sessionVariables.labelMaxWidth:this.labelMaxWidth?this.options.labelMaxWidth?this.options.labelMaxWidth:this.sessionVariables.labelMaxWidth:g,this.sessionVariables.labelMaxHeight=l):(this.sessionVariables.labelAngle=this.labelAngle,this.sessionVariables.labelMaxWidth=0===this.labelAngle?g:Math.min((b-l*Math.sin(Math.PI/180*Math.abs(this.labelAngle)))/Math.cos(Math.PI/180*Math.abs(this.labelAngle)),
l),r(this.options.labelWrap))?r(this.options.labelWrap)&&(this.labelWrap&&!r(this.options.labelMaxWidth)?(this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth?this.options.labelMaxWidth:this.sessionVariables.labelMaxWidth,this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxHeight=b):(this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth?this.options.labelMaxWidth:g,this.sessionVariables.labelMaxHeight=0===this.labelAngle?l:b,r(this.options.labelMaxWidth)&&
(this.sessionVariables.labelAngle=this.labelAngle))):this.options.labelWrap?(this.sessionVariables.labelMaxHeight=0===this.labelAngle?l:b,this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxWidth=g):(this.sessionVariables.labelMaxHeight=l,r(this.options.labelMaxWidth),this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth?this.options.labelMaxWidth:this.sessionVariables.labelMaxWidth,this.sessionVariables.labelWrap=this.labelWrap)}for(b=0;b<this._labels.length;b++)a=
...
r(this.sessionVariables.labelWrap)?this.sessionVariables.labelWrap=this.labelWrap:this.sessionVariables.labelWrap:this.options.labelWrap,a.maxHeight=r(this.sessionVariables.labelMaxHeight)?this.sessionVariables.labelMaxHeight=l:this.sessionVariables.labelMaxHeight,a.measureText();for(c=0;c<this.stripLines.length;c++){var g=this.stripLines[c],A;if("outside"===g.labelPlacement){l=this.sessionVariables.labelMaxWidth;if("bottom"===this._position||"top"===this._position)r(g.options.labelWrap)&&!r(this.sessionVariables.stripLineLabelMaxHeight)?
A=this.sessionVariables.stripLineLabelMaxHeight:this.sessionVariables.stripLineLabelMaxHeight=A=g.labelWrap?0.8*this.chart.height>>0:1.5*this.labelFontSize;if("left"===this._position||"right"===this._position)r(g.options.labelWrap)&&!r(this.sessionVariables.stripLineLabelMaxHeight)?A=this.sessionVariables.stripLineLabelMaxHeight:this.sessionVariables.stripLineLabelMaxHeight=A=g.labelWrap?0.8*this.chart.width>>0:1.5*this.labelFontSize;r(g.labelBackgroundColor)&&(g.labelBackgroundColor="#EEEEEE")}else l=
"bottom"===this._position||"top"===this._position?0.9*this.chart.width>>0:0.9*this.chart.height>>0,A=r(g.options.labelWrap)||g.labelWrap?"bottom"===this._position||"top"===this._position?0.8*this.chart.width>>0:0.8*this.chart.height>>0:1.5*this.labelFontSize,r(g.labelBackgroundColor)&&(r(g.startValue)&&0!==g.startValue?g.labelBackgroundColor=w?"transparent":null:g.labelBackgroundColor="#EEEEEE");a=new ja(this.ctx,{x:0,y:0,backgroundColor:g.labelBackgroundColor,borderColor:g.labelBorderColor,borderThickness:g.labelBorderThickness,
cornerRadius:g.labelCornerRadius,maxWidth:g.options.labelMaxWidth?g.options.labelMaxWidth:l,maxHeight:A,angle:this.labelAngle,text:g.labelFormatter?g.labelFormatter({chart:this.chart,axis:this,stripLine:g}):g.label,textAlign:this.labelTextAlign,fontSize:"outside"===g.labelPlacement?g.options.labelFontSize?g.labelFontSize:this.labelFontSize:g.labelFontSize,fontFamily:"outside"===g.labelPlacement?g.options.labelFontFamily?g.labelFontFamily:this.labelFontFamily:g.labelFontFamily,fontWeight:"outside"===
...
2:0)+a+("inside"===this.tickPlacement?0<this._index?this.tickLength:0:this.tickLength)+b};A.setLayout=function(a,d,c,b,e,g){var l,h,n,k,m=a[0]?a[0].chart:d[0].chart,p=m.isNavigator?0:10,q=m._axes;if(a&&0<a.length)for(var f=0;f<a.length;f++)a[f]&&a[f].calculateAxisParameters();if(d&&0<d.length)for(f=0;f<d.length;f++)d[f].calculateAxisParameters();if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].calculateAxisParameters();if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].calculateAxisParameters();for(f=0;f<q.length;f++)if(q[f]&&
q[f].scaleBreaks&&q[f].scaleBreaks._appliedBreaks.length)for(var s=q[f].scaleBreaks._appliedBreaks,w=0;w<s.length&&!(s[w].startValue>q[f].viewportMaximum);w++)s[w].endValue<q[f].viewportMinimum||(r(q[f].scaleBreaks.firstBreakIndex)&&(q[f].scaleBreaks.firstBreakIndex=w),s[w].startValue>=q[f].viewPortMinimum&&(q[f].scaleBreaks.lastBreakIndex=w));for(var v=w=0,u=0,y=0,x=0,z=0,A=0,C,B,E=h=0,G,J,K,s=G=J=K=!1,f=0;f<q.length;f++)q[f]&&q[f].title&&(q[f]._titleTextBlock=new ja(q[f].ctx,{text:q[f].title,horizontalAlign:"center",
...
0.8*g.width:1.5*q[f].titleFontSize;q[f]._titleTextBlock.angle=-90;break;case "right":q[f]._titleTextBlock.maxWidth=q[f].titleMaxWidth||g.height;q[f]._titleTextBlock.maxHeight=q[f].titleWrap?0.8*g.width:1.5*q[f].titleFontSize;q[f]._titleTextBlock.angle=90;break;default:q[f]._titleTextBlock.maxWidth=q[f].titleMaxWidth||g.width,q[f]._titleTextBlock.maxHeight=q[f].titleWrap?0.8*g.height:1.5*q[f].titleFontSize,q[f]._titleTextBlock.angle=0}if("normal"===e){for(var y=[],x=[],z=[],A=[],M=[],Q=[],O=[],P=[];4>
w;){var F=0,X=0,T=0,U=0,V=e=0,N=0,Z=0,W=0,Y=0,R=0,aa=0;if(c&&0<c.length)for(z=[],f=R=0;f<c.length;f++)z.push(Math.ceil(c[f]?c[f].createLabelsAndCalculateWidth():0)),R+=z[f],N+=c[f]&&!m.isNavigator?c[f].margin:0;else z.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));O.push(z);if(b&&0<b.length)for(A=[],f=aa=0;f<b.length;f++)A.push(Math.ceil(b[f]?b[f].createLabelsAndCalculateWidth():0)),aa+=A[f],Z+=b[f]?b[f].margin:0;else A.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));P.push(A);
l=Math.round(g.x1+R+N);n=Math.round(g.x2-aa-Z>m.width-p?m.width-p:g.x2-aa-Z);if(a&&0<a.length)for(y=[],f=W=0;f<a.length;f++)a[f]&&(a[f].lineCoordinates={}),a[f].lineCoordinates.width=Math.abs(n-l),a[f].title&&(a[f]._titleTextBlock.maxWidth=0<a[f].titleMaxWidth&&a[f].titleMaxWidth<a[f].lineCoordinates.width?a[f].titleMaxWidth:a[f].lineCoordinates.width),y.push(Math.ceil(a[f]?a[f].createLabelsAndCalculateHeight():0)),W+=y[f],e+=a[f]&&!m.isNavigator?a[f].margin:0;else y.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():
0));M.push(y);if(d&&0<d.length)for(x=[],f=Y=0;f<d.length;f++)d[f]&&(d[f].lineCoordinates={}),d[f].lineCoordinates.width=Math.abs(n-l),d[f].title&&(d[f]._titleTextBlock.maxWidth=0<d[f].titleMaxWidth&&d[f].titleMaxWidth<d[f].lineCoordinates.width?d[f].titleMaxWidth:d[f].lineCoordinates.width),x.push(Math.ceil(d[f]?d[f].createLabelsAndCalculateHeight():0)),Y+=x[f],V+=d[f]&&!m.isNavigator?d[f].margin:0;else x.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));Q.push(x);if(a&&0<a.length)for(f=
0;f<a.length;f++)a[f]&&(a[f].lineCoordinates.x1=l,n=Math.round(g.x2-aa-Z>m.width-p?m.width-p:g.x2-aa-Z),a[f]._labels&&1<a[f]._labels.length&&(h=k=0,k=a[f]._labels[1],h="dateTime"===a[f].valueType?a[f]._labels[a[f]._labels.length-2]:a[f]._labels[a[f]._labels.length-1],v=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),u=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+
(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[f]||(!a[f].labelAutoFit||r(C)||r(B)||m.isNavigator||m.stockChart)||(h=0,0<a[f].labelAngle?B+u>n&&(h+=0<a[f].labelAngle?B+u-n-aa:0):0>a[f].labelAngle?C-v<l&&C-v<a[f].viewportMinimum&&(E=l-(N+a[f].tickLength+z+C-v+a[f].labelFontSize/2)):0===a[f].labelAngle&&(B+u>n&&(h=B+u/2-n-aa),C-v<l&&C-v<a[f].viewportMinimum&&(E=l-N-a[f].tickLength-z-C+v/2)),a[f].viewportMaximum===a[f].maximum&&a[f].viewportMinimum===
a[f].minimum&&0<a[f].labelAngle&&0<h?n-=h:a[f].viewportMaximum===a[f].maximum&&a[f].viewportMinimum===a[f].minimum&&0>a[f].labelAngle&&0<E?l+=E:a[f].viewportMaximum===a[f].maximum&&a[f].viewportMinimum===a[f].minimum&&0===a[f].labelAngle&&(0<E&&(l+=E),0<h&&(n-=h))),m.panEnabled?W=r(m.sessionVariables.axisX.height)?m.sessionVariables.axisX.height=W:m.sessionVariables.axisX.height:m.sessionVariables.axisX.height=W,h=Math.round(g.y2-W-e+F),k=Math.round(g.y2),a[f].lineCoordinates.x2=n,a[f].lineCoordinates.width=
n-l,a[f].lineCoordinates.y1=h,a[f].lineCoordinates.y2=h+a[f].lineThickness/2,"inside"===a[f].labelPlacement&&0<f&&(a[f].lineCoordinates.y1=a[f-1].lineCoordinates.y2+F+(a[f].labelEffectiveHeight||0),a[f].lineCoordinates.y2=a[f].lineCoordinates.y1+a[f].lineThickness/2),"inside"===a[f].tickPlacement&&0<f&&(a[f].lineCoordinates.y1+=a[f].tickLength,a[f].lineCoordinates.y2=a[f].lineCoordinates.y1+a[f].lineThickness/2),a[f].bounds={x1:l,y1:h,x2:n,y2:k-(W+e-y[f]-F),width:n-l},a[f].bounds.height=a[f].bounds.y2-
a[f].bounds.y1),F+=y[f]+a[f].margin;if(d&&0<d.length)for(f=0;f<d.length;f++)d[f].lineCoordinates.x1=Math.round(g.x1+R+N),d[f].lineCoordinates.x2=Math.round(g.x2-aa-Z>m.width-p?m.width-p:g.x2-aa-Z),d[f].lineCoordinates.width=Math.abs(n-l),d[f]._labels&&1<d[f]._labels.length&&(k=d[f]._labels[1],h="dateTime"===d[f].valueType?d[f]._labels[d[f]._labels.length-2]:d[f]._labels[d[f]._labels.length-1],v=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/
2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),u=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),m.panEnabled?Y=r(m.sessionVariables.axisX2.height)?m.sessionVariables.axisX2.height=Y:m.sessionVariables.axisX2.height:m.sessionVariables.axisX2.height=Y,h=Math.round(g.y1),k=d[f].lineCoordinates.y1=h+Y+V-X,d[f].lineCoordinates.y2=h,"inside"===d[f].labelPlacement&&0<f&&(d[f].lineCoordinates.y1=
d[f-1].lineCoordinates.y1-X-(d[f].labelEffectiveHeight||0)),"inside"===d[f].tickPlacement&&0<f&&(d[f].lineCoordinates.y1-=d[f].tickLength),d[f].bounds={x1:l,y1:h+(Y+V-x[f]-X),x2:n,y2:k,width:n-l},d[f].bounds.height=d[f].bounds.y2-d[f].bounds.y1,X+=x[f]+d[f].margin;if(c&&0<c.length)for(f=0;f<c.length;f++)N=m.isNavigator?0:10,c[f]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=c[f]._labels&&0<c[f]._labels.length?c[f]._labels[c[f]._labels.length-1].textBlock.height/2:p,h=Math.round(g.y1+
Y+V<Math.max(N,p)?Math.max(N,p):g.y1+Y+V),n=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=0<a.length?0:c[f]._labels&&0<c[f]._labels.length?c[f]._labels[0].textBlock.height/2:p,k=Math.round(g.y2-W-e-N),c[f].lineCoordinates={x1:l-T,y1:h,x2:n-T,y2:k,height:Math.abs(k-h)},"inside"===c[f].labelPlacement&&0<f&&(c[f].lineCoordinates.x1=c[f-1].lineCoordinates.x1-T-(c[f].labelEffectiveWidth||0),c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+c[f].lineThickness/2),"inside"===c[f].tickPlacement&&
0<f&&(c[f].lineCoordinates.x1-=c[f].tickLength,c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+c[f].lineThickness/2),c[f].bounds={x1:l-(z[f]+T),y1:h,x2:n-T,y2:k,height:k-h},c[f].bounds.width=c[f].bounds.x2-c[f].bounds.x1,c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.height?c[f].titleMaxWidth:c[f].lineCoordinates.height),T+=z[f]+c[f].margin);if(b&&0<b.length)for(f=0;f<b.length;f++)b[f]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),
n=Math.round(l),N=b[f]._labels&&0<b[f]._labels.length?b[f]._labels[b[f]._labels.length-1].textBlock.height/2:0,h=Math.round(g.y1+Y+V<Math.max(N,p)?Math.max(N,p):g.y1+Y+V),N=0<a.length?0:b[f]._labels&&0<b[f]._labels.length?b[f]._labels[0].textBlock.height/2:0,k=Math.round(g.y2-(W+e+N)),b[f].lineCoordinates={x1:l+U,y1:h,x2:l+U,y2:k,height:Math.abs(k-h)},"inside"===b[f].labelPlacement&&0<f&&(b[f].lineCoordinates.x1=b[f-1].lineCoordinates.x2+U+(b[f].labelEffectiveWidth||0),b[f].lineCoordinates.x2=b[f].lineCoordinates.x1+
b[f].lineThickness/2),"inside"===b[f].tickPlacement&&0<f&&(b[f].lineCoordinates.x1+=b[f].tickLength,b[f].lineCoordinates.x2=b[f].lineCoordinates.x1+b[f].lineThickness/2),b[f].bounds={x1:l+U,y1:h,x2:n+(A[f]+U),y2:k,height:k-h},b[f].bounds.width=b[f].bounds.x2-b[f].bounds.x1,b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.height?b[f].titleMaxWidth:b[f].lineCoordinates.height),U+=A[f]+b[f].margin);if(a&&0<a.length)for(f=0;f<a.length;f++)a[f]&&
(a[f].calculateValueToPixelConversionParameters(),a[f].calculateBreaksSizeInValues(),a[f]._labels&&1<a[f]._labels.length&&(C=(a[f].logarithmic?Math.log(a[f]._labels[1].position/a[f].viewportMinimum)/a[f].conversionParameters.lnLogarithmBase:a[f]._labels[1].position-a[f].viewportMinimum)*Math.abs(a[f].conversionParameters.pixelPerUnit)+a[f].lineCoordinates.x1,l=a[f]._labels[a[f]._labels.length-("dateTime"===a[f].valueType?2:1)].position,l=a[f].getApparentDifference(a[f].viewportMinimum,l),B=a[f].logarithmic?
(1<l?Math.log(l)/a[f].conversionParameters.lnLogarithmBase*Math.abs(a[f].conversionParameters.pixelPerUnit):0)+a[f].lineCoordinates.x1:(0<l?l*Math.abs(a[f].conversionParameters.pixelPerUnit):0)+a[f].lineCoordinates.x1));if(d&&0<d.length)for(f=0;f<d.length;f++)d[f].calculateValueToPixelConversionParameters(),d[f].calculateBreaksSizeInValues(),d[f]._labels&&1<d[f]._labels.length&&(C=(d[f].logarithmic?Math.log(d[f]._labels[1].position/d[f].viewportMinimum)/d[f].conversionParameters.lnLogarithmBase:d[f]._labels[1].position-
d[f].viewportMinimum)*Math.abs(d[f].conversionParameters.pixelPerUnit)+d[f].lineCoordinates.x1,l=d[f]._labels[d[f]._labels.length-("dateTime"===d[f].valueType?2:1)].position,l=d[f].getApparentDifference(d[f].viewportMinimum,l),B=d[f].logarithmic?(1<l?Math.log(l)/d[f].conversionParameters.lnLogarithmBase*Math.abs(d[f].conversionParameters.pixelPerUnit):0)+d[f].lineCoordinates.x1:(0<l?l*Math.abs(d[f].conversionParameters.pixelPerUnit):0)+d[f].lineCoordinates.x1);for(f=0;f<q.length;f++)"axisY"===q[f].type&&
(q[f].calculateValueToPixelConversionParameters(),q[f].calculateBreaksSizeInValues());if(0<w){if(a&&0<a.length)for(f=0;f<a.length;f++)s=M[w-1][f]===M[w][f]?!0:!1;else s=!0;if(d&&0<d.length)for(f=0;f<d.length;f++)G=Q[w-1][f]===Q[w][f]?!0:!1;else G=!0;if(c&&0<c.length)for(f=0;f<c.length;f++)J=O[w-1][f]===O[w][f]?!0:!1;else J=!0;if(b&&0<b.length)for(f=0;f<b.length;f++)K=P[w-1][f]===P[w][f]?!0:!1;else K=!0}if(s&&G&&J&&K)break;w++}if(a&&0<a.length)for(f=0;f<a.length;f++)a[f].calculateStripLinesThicknessInValues(),
a[f].calculateBreaksInPixels();if(d&&0<d.length)for(f=0;f<d.length;f++)d[f].calculateStripLinesThicknessInValues(),d[f].calculateBreaksInPixels();if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].calculateStripLinesThicknessInValues(),c[f].calculateBreaksInPixels();if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].calculateStripLinesThicknessInValues(),b[f].calculateBreaksInPixels()}else{p=[];C=[];E=[];v=[];B=[];u=[];M=[];for(Q=[];4>w;){W=U=T=Z=N=V=e=P=O=F=Y=0;if(a&&0<a.length)for(E=[],f=U=0;f<a.length;f++)E.push(Math.ceil(a[f]?
a[f].createLabelsAndCalculateWidth():0)),U+=E[f],e+=a[f]&&!m.isNavigator?a[f].margin:0;else E.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));M.push(E);if(d&&0<d.length)for(v=[],f=W=0;f<d.length;f++)v.push(Math.ceil(d[f]?d[f].createLabelsAndCalculateWidth():0)),W+=v[f],V+=d[f]?d[f].margin:0;else v.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():0));Q.push(v);if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].lineCoordinates={},l=Math.round(g.x1+U+e),n=Math.round(g.x2-W-V>m.width-10?
m.width-10:g.x2-W-V),c[f].labelAutoFit&&!r(y)&&(0<!a.length&&(l=0>c[f].labelAngle?Math.max(l,y):0===c[f].labelAngle?Math.max(l,y/2):l),0<!d.length&&(n=0<c[f].labelAngle?n-x/2:0===c[f].labelAngle?n-x/2:n)),c[f].lineCoordinates.x1=l,c[f].lineCoordinates.x2=n,c[f].lineCoordinates.width=Math.abs(n-l),c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.width?c[f].titleMaxWidth:c[f].lineCoordinates.width);if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].lineCoordinates=
{},l=Math.round(g.x1+U+e),n=Math.round(g.x2-W-V>b[f].chart.width-10?b[f].chart.width-10:g.x2-W-V),b[f]&&b[f].labelAutoFit&&!r(z)&&(0<!a.length&&(l=0<b[f].labelAngle?Math.max(l,z):0===b[f].labelAngle?Math.max(l,z/2):l),0<!d.length&&(n-=A/2)),b[f].lineCoordinates.x1=l,b[f].lineCoordinates.x2=n,b[f].lineCoordinates.width=Math.abs(n-l),b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.width?b[f].titleMaxWidth:b[f].lineCoordinates.width);if(c&&0<c.length)for(p=
[],f=T=0;f<c.length;f++)p.push(Math.ceil(c[f]?c[f].createLabelsAndCalculateHeight():0)),T+=p[f]+c[f].margin,N+=c[f].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));B.push(p);if(b&&0<b.length)for(C=[],f=0;f<b.length;f++)C.push(Math.ceil(b[f]?b[f].createLabelsAndCalculateHeight():0)),Z+=b[f].margin;else C.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateHeight():0));u.push(C);if(c&&0<c.length)for(f=0;f<c.length;f++)0<c[f]._labels.length&&(k=c[f]._labels[0],h=c[f]._labels[c[f]._labels.length-
...
(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),A=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)));if(m.panEnabled)for(f=0;f<c.length;f++)p[f]=r(m.sessionVariables.axisY.height)?m.sessionVariables.axisY.height=p[f]:m.sessionVariables.axisY.height;else for(f=0;f<c.length;f++)m.sessionVariables.axisY.height=p[f];if(c&&0<c.length)for(f=c.length-
1;0<=f;f--)h=Math.round(g.y2),k=Math.round(g.y2>c[f].chart.height?c[f].chart.height:g.y2),c[f].lineCoordinates.y1=h-(p[f]+c[f].margin+Y),c[f].lineCoordinates.y2=h-(p[f]+c[f].margin+Y),"inside"===c[f].labelPlacement&&0<f&&(c[f].lineCoordinates.y1=c[f].lineCoordinates.y1+p[f]-(c[f]._titleTextBlock?c[f]._titleTextBlock.height:0)-c[f].tickLength-(c[f].stripLineLabelEffectiveHeight||0)-5,c[f].lineCoordinates.y2=c[f].lineCoordinates.y1+c[f].lineThickness/2),"inside"===c[f].tickPlacement&&0<f&&(c[f].lineCoordinates.y1+=
c[f].tickLength,c[f].lineCoordinates.y2=c[f].lineCoordinates.y1+c[f].lineThickness/2),c[f].bounds={x1:l,y1:h-(p[f]+Y+c[f].margin),x2:n,y2:k-(Y+c[f].margin),width:n-l,height:p[f]},c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.width?c[f].titleMaxWidth:c[f].lineCoordinates.width),Y+=p[f]+c[f].margin;if(b&&0<b.length)for(f=b.length-1;0<=f;f--)b[f]&&(h=Math.round(g.y1),k=Math.round(g.y1+(C[f]+b[f].margin+F)),b[f].lineCoordinates.y1=k,b[f].lineCoordinates.y2=
k,"inside"===b[f].labelPlacement&&0<f&&(b[f].lineCoordinates.y1=k-C[f]+(b[f]._titleTextBlock?b[f]._titleTextBlock.height:0)+b[f].tickLength+(b[f].stripLineLabelEffectiveHeight||0),b[f].lineCoordinates.y2=b[f].lineCoordinates.y1-b[f].lineThickness/2),"inside"===b[f].tickPlacement&&0<f&&(b[f].lineCoordinates.y1-=b[f].tickLength,b[f].lineCoordinates.y2=b[f].lineCoordinates.y1-b[f].lineThickness/2),b[f].bounds={x1:l,y1:h+(b[f].margin+F),x2:n,y2:k,width:n-l},b[f].bounds.height=b[f].bounds.y2-b[f].bounds.y1,
b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.width?b[f].titleMaxWidth:b[f].lineCoordinates.width),F+=C[f]+b[f].margin);if(a&&0<a.length)for(f=0;f<a.length;f++){N=a[f]._labels&&0<a[f]._labels.length?a[f]._labels[0].textBlock.fontSize/2:0;l=Math.round(g.x1+e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:g.y1<Math.max(N,10)?Math.max(N,10):g.y1):g.y1<Math.max(N,10)?Math.max(N,10):g.y1;n=Math.round(g.x1+U+e);k=c&&0<c.length?Math.round(c[0]?
c[0].lineCoordinates.y1:g.y2-T>m.height-Math.max(N,10)?m.height-Math.max(N,10):g.y2-T):g.y2>m.height-Math.max(N,10)?m.height-Math.max(N,10):g.y2;if(c&&0<c.length)for(N=0;N<c.length;N++)c[N]&&c[N].labelAutoFit&&(n=0>c[N].labelAngle?Math.max(n,y):0===c[N].labelAngle?Math.max(n,y/2):n,l=0>c[N].labelAngle||0===c[N].labelAngle?n-U:l);if(b&&0<b.length)for(N=0;N<b.length;N++)b[N]&&b[N].labelAutoFit&&(n=b[N].lineCoordinates.x1,l=n-U);a[f].lineCoordinates={x1:n-O,y1:h,x2:n-O,y2:k,height:Math.abs(k-h)};"inside"===
a[f].labelPlacement&&0<f&&(a[f].lineCoordinates.x1=a[f].lineCoordinates.x1-(E[f]-(a[f]._titleTextBlock?a[f]._titleTextBlock.height:0))+a[f].tickLength+(a[f].stripLineLabelEffectiveWidth||0),a[f].lineCoordinates.x2=a[f].lineCoordinates.x1+a[f].lineThickness/2);"inside"===a[f].tickPlacement&&0<f&&(a[f].lineCoordinates.x1-=a[f].tickLength,a[f].lineCoordinates.x2=a[f].lineCoordinates.x1+a[f].lineThickness/2);a[f].bounds={x1:n-(E[f]+O),y1:h,x2:n-O,y2:k,height:k-h};a[f].bounds.width=a[f].bounds.x2-a[f].bounds.x1;
a[f].title&&(a[f]._titleTextBlock.maxWidth=0<a[f].titleMaxWidth&&a[f].titleMaxWidth<a[f].lineCoordinates.height?a[f].titleMaxWidth:a[f].lineCoordinates.height);a[f].calculateValueToPixelConversionParameters();a[f].calculateBreaksSizeInValues();O+=E[f]+a[f].margin}if(d&&0<d.length)for(f=0;f<d.length;f++){N=d[f]._labels&&0<d[f]._labels.length?d[f]._labels[0].textBlock.fontSize/2:0;l=Math.round(g.x1-e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:g.y1<Math.max(N,10)?Math.max(N,10):g.y1):g.y1<
Math.max(N,10)?Math.max(N,10):g.y1;n=Math.round(g.x2-W-V);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:g.y2-T>m.height-Math.max(N,10)?m.height-Math.max(N,10):g.y2-T):g.y2>m.height-Math.max(N,10)?m.height-Math.max(N,10):g.y2;if(c&&0<c.length)for(N=0;N<c.length;N++)c[N]&&c[N].labelAutoFit&&(n=0>c[N].labelAngle?Math.max(n,y):0===c[N].labelAngle?Math.max(n,y/2):n,l=0>c[N].labelAngle||0===c[N].labelAngle?n-W:l);if(b&&0<b.length)for(N=0;N<b.length;N++)b[N]&&b[N].labelAutoFit&&(n=b[N].lineCoordinates.x2,
l=n-W);d[f].lineCoordinates={x1:n+P,y1:h,x2:n+P,y2:k,height:Math.abs(k-h)};"inside"===d[f].labelPlacement&&0<f&&(d[f].lineCoordinates.x1=d[f].lineCoordinates.x1+(v[f]-(d[f]._titleTextBlock?d[f]._titleTextBlock.height:0)-2)-d[f].tickLength-(d[f].stripLineLabelEffectiveWidth||0),d[f].lineCoordinates.x2=d[f].lineCoordinates.x1+d[f].lineThickness/2);"inside"===d[f].tickPlacement&&0<f&&(d[f].lineCoordinates.x1+=d[f].tickLength,d[f].lineCoordinates.x2=d[f].lineCoordinates.x1+d[f].lineThickness/2);d[f].bounds=
{x1:d[f].lineCoordinates.x1,y1:h,x2:n+v[f]+P,y2:k,width:n-l,height:k-h};d[f].bounds.width=d[f].bounds.x2-d[f].bounds.x1;d[f].title&&(d[f]._titleTextBlock.maxWidth=0<d[f].titleMaxWidth&&d[f].titleMaxWidth<d[f].lineCoordinates.height?d[f].titleMaxWidth:d[f].lineCoordinates.height);d[f].calculateValueToPixelConversionParameters();d[f].calculateBreaksSizeInValues();P+=v[f]+d[f].margin}for(f=0;f<q.length;f++)"axisY"===q[f].type&&(q[f].calculateValueToPixelConversionParameters(),q[f].calculateBreaksSizeInValues());
if(0<w){if(a&&0<a.length)for(f=0;f<a.length;f++)s=M[w-1][f]===M[w][f]?!0:!1;else s=!0;if(d&&0<d.length)for(f=0;f<d.length;f++)G=Q[w-1][f]===Q[w][f]?!0:!1;else G=!0;if(c&&0<c.length)for(f=0;f<c.length;f++)J=B[w-1][f]===B[w][f]?!0:!1;else J=!0;if(b&&0<b.length)for(f=0;f<b.length;f++)K=u[w-1][f]===u[w][f]?!0:!1;else K=!0}if(s&&G&&J&&K)break;w++}if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].calculateStripLinesThicknessInValues(),c[f].calculateBreaksInPixels();if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].calculateStripLinesThicknessInValues(),
b[f].calculateBreaksInPixels();if(a&&0<a.length)for(f=0;f<a.length;f++)a[f].calculateStripLinesThicknessInValues(),a[f].calculateBreaksInPixels();if(d&&0<d.length)for(f=0;f<d.length;f++)d[f].calculateStripLinesThicknessInValues(),d[f].calculateBreaksInPixels()}};A.render=function(a,d,c,b,e){var g=a[0]?a[0].chart:d[0].chart;e=g.ctx;g.alignVerticalAxes&&g.alignVerticalAxes();e.save();e.beginPath();a&&a.length&&e.rect(5,a[0].bounds.y1,a[0].chart.width-10,a[a.length-1].bounds.y2);d&&d.length&&e.rect(5,
d[d.length-1].bounds.y1,d[0].chart.width-10,d[0].bounds.y2);e.clip();if(a&&0<a.length)for(var l=0;l<a.length;l++)a[l].renderLabelsTicksAndTitle();if(d&&0<d.length)for(l=0;l<d.length;l++)d[l].renderLabelsTicksAndTitle();e.restore();if(c&&0<c.length)for(l=0;l<c.length;l++)c[l].renderLabelsTicksAndTitle();if(b&&0<b.length)for(l=0;l<b.length;l++)b[l].renderLabelsTicksAndTitle();g.preparePlotArea();g=g.plotArea;e.save();e.beginPath();e.rect(g.x1,g.y1,Math.abs(g.x2-g.x1),Math.abs(g.y2-g.y1));e.clip();if(a&&
...
this.lineCoordinates.width||this.chart.width,d=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[],c=this.conversionParameters.pixelPerUnit||a/(this.logarithmic?this.conversionParameters.maximum/this.conversionParameters.minimum:this.conversionParameters.maximum-this.conversionParameters.minimum),b=this.scaleBreaks&&!r(this.scaleBreaks.options.spacing),e,g=0;g<d.length;g++)e=b||!r(d[g].options.spacing),d[g].spacing=Ta(d[g].spacing,a,8,e?0.1*a:8,e?0:3)<<0,d[g].size=0>d[g].spacing?0:Math.abs(d[g].spacing/
c),this.logarithmic&&(d[g].size=Math.pow(this.logarithmBase,d[g].size))};A.prototype.calculateBreaksInPixels=function(){if(!(this.scaleBreaks&&0>=this.scaleBreaks._appliedBreaks.length)){var a=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];a.length&&(this.scaleBreaks.firstBreakIndex=this.scaleBreaks.lastBreakIndex=null);for(var d=0;d<a.length&&!(a[d].startValue>this.conversionParameters.maximum);d++)a[d].endValue<this.conversionParameters.minimum||(r(this.scaleBreaks.firstBreakIndex)&&(this.scaleBreaks.firstBreakIndex=
d),a[d].startValue>=this.conversionParameters.minimum&&(a[d].startPixel=this.convertValueToPixel(a[d].startValue),this.scaleBreaks.lastBreakIndex=d),a[d].endValue<=this.conversionParameters.maximum&&(a[d].endPixel=this.convertValueToPixel(a[d].endValue)))}};A.prototype.renderLabelsTicksAndTitle=function(){var a=this,d=!1,c=0,b=0,e=1,g=0;0!==this.labelAngle&&360!==this.labelAngle&&(e=1.2);if("undefined"===typeof this.options.interval){if("bottom"===this._position||"top"===this._position)if(this.logarithmic&&
...
"inside"!=this.tickPlacement&&(this.ctx.lineWidth=this.tickThickness,this.ctx.strokeStyle=this.tickColor,b=1===this.ctx.lineWidth%2?(q.x<<0)+0.5:q.x<<0,this.ctx.beginPath(),this.ctx.moveTo(b,q.y<<0),this.ctx.lineTo(b,q.y+this.tickLength<<0),this.ctx.stroke()),d&&0!==g++%2&&this.labelAutoFit||(0===p.textBlock.angle?(q.x-=p.textBlock.width/2,q.y="inside"===this.labelPlacement?q.y-(("inside"===this.tickPlacement?this.tickLength:0)+p.textBlock.height-p.textBlock.fontSize/2):q.y+("inside"===this.tickPlacement?
...
this._labels[k],p.position<this.viewportMinimum||p.position>this.viewportMaximum||(q=this.getPixelCoordinatesOnAxis(p.position),this.tickThickness&&"inside"!=this.tickPlacement&&(this.ctx.lineWidth=this.tickThickness,this.ctx.strokeStyle=this.tickColor,b=1===this.ctx.lineWidth%2?(q.x<<0)+0.5:q.x<<0,this.ctx.beginPath(),this.ctx.moveTo(b,q.y<<0),this.ctx.lineTo(b,q.y-this.tickLength<<0),this.ctx.stroke()),d&&0!==g++%2&&this.labelAutoFit||(0===p.textBlock.angle?(q.x-=p.textBlock.width/2,q.y="inside"===
...
b=1===this.ctx.lineWidth%2?(q.y<<0)+0.5:q.y<<0,this.ctx.beginPath(),this.ctx.moveTo(q.x<<0,b),this.ctx.lineTo(q.x-this.tickLength<<0,b),this.ctx.stroke()),d&&0!==g++%2&&this.labelAutoFit||(0===this.labelAngle?(p.textBlock.y=q.y,p.textBlock.x="inside"===this.labelPlacement?q.x+("inside"===this.tickPlacement?this.tickLength:0)+5:q.x-p.textBlock.width*Math.cos(Math.PI/180*this.labelAngle)-("inside"===this.tickPlacement?0:this.tickLength)-5):(p.textBlock.y="inside"===this.labelPlacement?q.y:q.y-p.textBlock.width*
...
d>=e[g].endValue?c=c-e[g].endValue+a+e[g].size*(e[g].endValue-a)/(e[g].endValue-e[g].startValue):a<=e[g].startValue&&d<e[g].endValue?c=c-d+e[g].startValue+e[g].size*(d-e[g].startValue)/(e[g].endValue-e[g].startValue):!b&&(a>e[g].startValue&&d<e[g].endValue)&&(c=a+e[g].size*(d-a)/(e[g].endValue-e[g].startValue)));return c};A.prototype.setViewPortRange=function(a,d){this.sessionVariables.newViewportMinimum=this.viewportMinimum=Math.min(a,d);this.sessionVariables.newViewportMaximum=this.viewportMaximum=
...
T.yearDuration),this.intervalType="year"));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=e-h/2;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=g+h/2;d?this.autoValueFormatString="MMM DD YYYY HH:mm":"year"===this.intervalType?this.autoValueFormatString="YYYY":"month"===this.intervalType?this.autoValueFormatString="MMM YYYY":"week"===this.intervalType?this.autoValueFormatString="MMM DD YYYY":"day"===this.intervalType?this.autoValueFormatString=
...
e=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue);this.ctx.strokeStyle=this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;X(this.id);var g,h,n,r,k,m;a=Math.max(this.spacing,3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(J(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,h=1===p%2?(e.x<<0)+0.5:
e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,n=this.chart.plotArea.y2+p/2+0.5<<0):(e=this.chart.plotArea.y2,n=this.chart.plotArea.y1-p/2+0.5<<0,a*=-1),this.bounds={x1:b-p/2,y1:e,x2:h+p/2,y2:n},this.ctx.moveTo(b,e),"straight"===this.type||"top"===this.scaleBreaks.parent._position&&0>=a||"bottom"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(b,n),this.ctx.lineTo(h,n),this.ctx.lineTo(h,e);else if("wavy"===this.type){r=b;k=e;g=0.5;m=(n-k)/a/3;for(var q=0;q<m;q++)this.ctx.bezierCurveTo(r+
g*a,k+a,r+g*a,k+2*a,r,k+3*a),k+=3*a,g*=-1;this.ctx.bezierCurveTo(r+g*a,k+a,r+g*a,k+2*a,r,k+3*a);r=h;g*=-1;this.ctx.lineTo(r,k);for(q=0;q<m;q++)this.ctx.bezierCurveTo(r+g*a,k-a,r+g*a,k-2*a,r,k-3*a),k-=3*a,g*=-1}else{if("zigzag"===this.type){g=-1;k=e+a;r=b+a;m=(n-k)/a/2;for(q=0;q<m;q++)this.ctx.lineTo(r,k),r+=2*g*a,k+=2*a,g*=-1;this.ctx.lineTo(r,k);r+=h-b;for(q=0;q<m+1;q++)this.ctx.lineTo(r,k),r+=2*g*a,k-=2*a,g*=-1;this.ctx.lineTo(r+g*a,k+a)}}else if("left"===this.scaleBreaks.parent._position||"right"===
this.scaleBreaks.parent._position)if(e=1===p%2?(e.y<<0)+0.5:e.y<<0,n=1===p%2?(b.y<<0)+0.5:b.y<<0,"left"===this.scaleBreaks.parent._position?(b=this.chart.plotArea.x1,h=this.chart.plotArea.x2+p/2+0.5<<0):(b=this.chart.plotArea.x2,h=this.chart.plotArea.x1-p/2+0.5<<0,a*=-1),this.bounds={x1:b,y1:e-p/2,x2:h,y2:n+p/2},this.ctx.moveTo(b,e),"straight"===this.type||"left"===this.scaleBreaks.parent._position&&0>=a||"right"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(h,e),this.ctx.lineTo(h,n),
this.ctx.lineTo(b,n);else if("wavy"===this.type){r=b;k=e;g=0.5;m=(h-r)/a/3;for(q=0;q<m;q++)this.ctx.bezierCurveTo(r+a,k+g*a,r+2*a,k+g*a,r+3*a,k),r+=3*a,g*=-1;this.ctx.bezierCurveTo(r+a,k+g*a,r+2*a,k+g*a,r+3*a,k);k=n;g*=-1;this.ctx.lineTo(r,k);for(q=0;q<m;q++)this.ctx.bezierCurveTo(r-a,k+g*a,r-2*a,k+g*a,r-3*a,k),r-=3*a,g*=-1}else if("zigzag"===this.type){g=1;k=e-a;r=b+a;m=(h-r)/a/2;for(q=0;q<m;q++)this.ctx.lineTo(r,k),k+=2*g*a,r+=2*a,g*=-1;this.ctx.lineTo(r,k);k+=n-e;for(q=0;q<m+1;q++)this.ctx.lineTo(r,
...
c;X(this.id);var e,g,h,n;this.ctx.lineWidth=d;this.ctx.setLineDash&&this.ctx.setLineDash(J(this.lineDashType,d));if("bottom"===this.parent._position||"top"===this.parent._position)e=g=1===this.ctx.lineWidth%2?(a.x<<0)+0.5:a.x<<0,h=this.chart.plotArea.y1,n=this.chart.plotArea.y2,this.bounds={x1:e-d/2,y1:h,x2:g+d/2,y2:n};else if("left"===this.parent._position||"right"===this.parent._position)h=n=1===this.ctx.lineWidth%2?(a.y<<0)+0.5:a.y<<0,e=this.chart.plotArea.x1,g=this.chart.plotArea.x2,this.bounds=
{x1:e,y1:h-d/2,x2:g,y2:n+d/2};this.ctx.moveTo(e,h);this.ctx.lineTo(g,n);this.ctx.stroke();this.ctx.globalAlpha=b}this.ctx.restore()};oa(ca,G);ca.prototype.showAt=function(a){if(!this.enabled)return!1;var d=this.chart,c=!1;d.resetOverlayedCanvas();d.clearedOverlayedCanvas=this.parent.type;this.chart.renderCrosshairs(this.parent);if("xySwapped"===d.plotInfo.axisPlacement)if("bottom"===this.parent._position)for(var b=0;b<d.axisY.length;b++)this.parent===d.axisY[b]&&(d.axisY[b]._crosshairValue=a>=d.axisY[b].viewportMinimum&&
...
(c=!0));this.chart.toolTip&&this.chart.toolTip._entries&&this.chart.toolTip.highlightObjects(this.chart.toolTip._entries);return c};ca.prototype.hide=function(){this.chart.resetOverlayedCanvas();this.chart.renderCrosshairs(this.parent);this._hidden=!0};ca.prototype.render=function(a,d,c){var b,e,g,h,n=null,w=null,k=null,m="";if(!this.valueFormatString)if("dateTime"===this.parent.valueType)this.valueFormatString=this.parent.valueFormatString;else{var p=0,p="xySwapped"===this.chart.plotInfo.axisPlacement?
...
crosshair:this.options,value:y.dataPoint.y}):r(this.options.label)?da(r(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=n;g=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:g,x2:e+p/2,y2:h};k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2?k.x=this.chart.bounds.x2-k.width:k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);k.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-k.height+this.parent.tickLength:k.fontSize/
2)+2;k.y+k.height>this.chart.bounds.y2?k.y=this.chart.bounds.y2-k.height:k.y<this.chart.bounds.y1&&(k.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){g=h=w=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:g-p/2,x2:e,y2:h+p/2};z=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),s=0;s<this.parent.viewportMaximum;s+=
...
this.parent.dataSeries[B].getDataPointAtX(s,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[B],null!==v.dataPoint.y&&v.dataSeries.visible&&m.push(v));if(0===m.length)return;m.sort(function(a,b){return a.distance-b.distance});y=m[0];b=e=n=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.x)<<0;g=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:g,x2:e+p/2,y2:h};z=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),
...
2),"bottom"===this.parent._position&&this.parent.lineCoordinates.y2-k.fontSize/2+k.measureText().height>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.height+k.fontSize/2+2),b>=this.parent.convertValueToPixel(this.parent.reversed?this.parent.viewportMaximum:this.parent.viewportMinimum)&&e<=this.parent.convertValueToPixel(this.parent.reversed?this.parent.viewportMinimum:this.parent.viewportMaximum)&&(0<p&&(q.moveTo(b,g),q.lineTo(e,h),q.stroke(),this._hidden=!1),q.restore());if("left"===this.parent._position||
"right"===this.parent._position)"left"===this.parent._position&&k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1),"right"===this.parent._position&&k.x+k.measureText().width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.measureText().width),h>=this.parent.convertValueToPixel(this.parent.reversed?this.parent.viewportMinimum:this.parent.viewportMaximum)&&g<=this.parent.convertValueToPixel(this.parent.reversed?this.parent.viewportMaximum:this.parent.viewportMinimum)&&(0<p&&(q.moveTo(b,g),q.lineTo(e,
h),q.stroke(),this._hidden=!1),q.restore())}else{if("bottom"===this.parent._position||"top"===this.parent._position)b=e=n=1===q.lineWidth%2?(a<<0)+0.5:a<<0,g=this.chart.plotArea.y1,h=this.chart.plotArea.y2,this.bounds={x1:b-p/2,y1:g,x2:e+p/2,y2:h};else if("left"===this.parent._position||"right"===this.parent._position)g=h=w=1===q.lineWidth%2?(d<<0)+0.5:d<<0,b=this.chart.plotArea.x1,e=this.chart.plotArea.x2,this.bounds={x1:b,y1:g-p/2,x2:e,y2:h+p/2};if("xySwapped"===this.chart.plotInfo.axisPlacement)if("left"===
...
typeof a||"undefined"===typeof d){if(isNaN(this._prevX)||isNaN(this._prevY))return;a=this._prevX;d=this._prevY}else this._prevX=a,this._prevY=d;var b=null,e=null,g=[],h=0;if(this.shared&&this.enabled&&"none"!==this.chart.plotInfo.axisPlacement){var n=[];if(this.chart.axisX)for(var v=0;v<this.chart.axisX.length;v++){for(var h="xySwapped"===this.chart.plotInfo.axisPlacement?this.chart.axisX[v].convertPixelToValue({y:d}):this.chart.axisX[v].convertPixelToValue({x:a}),k=null,b=0;b<this.chart.axisX[v].dataSeries.length;b++)(k=
...
c))&&0<=k.index&&(k.dataSeries=this.chart.axisX2[v].dataSeries[b],null!==k.dataPoint.y&&k.dataSeries.visible&&n.push(k));k=null}if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});c=n[0];for(b=0;b<n.length;b++)n[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&g.push(n[b]);n=null}else{if(b=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=b.dataPointIndex,this.currentSeriesIndex=b.dataSeries.index;else if(w)if(b=$a(a,d,this.chart._eventManager.ghostCtx),0<b&&
...
this.fontStyle?this.fontStyle:w?"italic":"normal"}catch(m){}"pie"===g[0].dataSeries.type||"doughnut"===g[0].dataSeries.type||"funnel"===g[0].dataSeries.type||"pyramid"===g[0].dataSeries.type||"bar"===g[0].dataSeries.type||"rangeBar"===g[0].dataSeries.type||"stackedBar"===g[0].dataSeries.type||"stackedBar100"===g[0].dataSeries.type?a=a-10-this.container.clientWidth:(a=g[0].dataSeries.axisX.convertValueToPixel(g[0].dataPoint.x)-this.container.clientWidth<<0,a-=10);0>a&&(a+=this.container.clientWidth+
...
g.size=Math.max(1.5*g.size<<0,10),g.borderColor=g.borderColor||"#FFFFFF",g.borderThickness=g.borderThickness||Math.ceil(0.1*g.size),W.drawMarkers([g]),"undefined"!==typeof e.y2&&(g=b.getMarkerProperties(h,e.x1,e.y2,this.chart.overlaidCanvasCtx),g.size=Math.max(1.5*g.size<<0,10),g.borderColor=g.borderColor||"#FFFFFF",g.borderThickness=g.borderThickness||Math.ceil(0.1*g.size),W.drawMarkers([g]))):"bubble"===b.type?(g=b.getMarkerProperties(h,e.x1,e.y1,this.chart.overlaidCanvasCtx),g.size=e.size,g.color=
"white",g.borderColor="white",d.globalAlpha=0.3,W.drawMarkers([g]),d.globalAlpha=1):"column"===b.type||"stackedColumn"===b.type||"stackedColumn100"===b.type||"bar"===b.type||"rangeBar"===b.type||"stackedBar"===b.type||"stackedBar100"===b.type||"rangeColumn"===b.type||"waterfall"===b.type?Y(d,e.x1,e.y1,e.x2,e.y2,"white",0,null,!1,!1,!1,!1,0.3):"pie"===b.type||"doughnut"===b.type?pa(d,e.center,e.radius,"white",b.type,e.startAngle,e.endAngle,0.3,e.percentInnerRadius):"funnel"===b.type||"pyramid"===b.type?
...
c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":""),g+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span data-color='\""+(this.options.fontColor?"":"'{color}'")+"\"'>{name}:</span>&nbsp;&nbsp;{y}",n=c.axisXIndex):"bubble"===c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":
"X:{axisXIndex}<br/>":""),g+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span data-color='\""+(this.options.fontColor?"":"'{color}'")+"\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}"):"rangeColumn"===c.type||"rangeBar"===c.type||"rangeArea"===c.type||"rangeSplineArea"===c.type||"error"===c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":
""),g+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span data-color='\""+(this.options.fontColor?"":"'{color}'")+"\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}"):"candlestick"===c.type||"ohlc"===c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":""),g+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&
"function"!==typeof this.content?this.content:"<span data-color='\""+(this.options.fontColor?"":"'{color}'")+"\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}"):"boxAndWhisker"===c.type&&(this.chart.axisX&&1<this.chart.axisX.length&&(g+=n!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":""),g+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==
...
"":"'{color}'")+"\"'>"+(b.label?"{label}":"{x}")+"</span><br/>Minimum: &nbsp;{y[0]}<br/>Q1:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[1]}<br/>Q2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[4]}<br/>Q3:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Maximum: &nbsp;{y[3]}");null===d&&(d="");d+=this.chart.replaceKeywordsWithValue(g,b,c,e)}return d};U.prototype.enableAnimation=function(){if(!this.container.style.WebkitTransition){var a=
...
0===this.fontSize?this.fontSize+"px":"14px",this.contentDiv.style.color=this.fontColor?this.fontColor:"#000000",this.contentDiv.style.fontFamily=this.fontFamily?this.fontFamily:"Calibri, Arial, Georgia, serif;",this.contentDiv.style.fontWeight=this.fontWeight?this.fontWeight:"normal",this.contentDiv.style.fontStyle=this.fontStyle?this.fontStyle:w?"italic":"normal"}catch(n){}"pie"===g[0].dataSeries.type||"doughnut"===g[0].dataSeries.type||"funnel"===g[0].dataSeries.type||"pyramid"===g[0].dataSeries.type?
...
d,c,b){return c*a/b+d},easeOutQuad:function(a,d,c,b){return-c*(a/=b)*(a-2)+d},easeOutQuart:function(a,d,c,b){return-c*((a=a/b-1)*a*a*a-1)+d},easeInQuad:function(a,d,c,b){return c*(a/=b)*a+d},easeInQuart:function(a,d,c,b){return c*(a/=b)*a*a*a+d}}},W={drawMarker:function(a,d,c,b,e,g,h,n){if(c){var r=1;c.fillStyle=g?g:"#000000";c.strokeStyle=h?h:"#000000";c.lineWidth=n?n:0;c.setLineDash&&c.setLineDash(J("solid",n));"circle"===b?(c.moveTo(a,d),c.beginPath(),c.arc(a,d,e/2,0,2*Math.PI,!1),g&&c.fill(),
n&&(h?c.stroke():(r=c.globalAlpha,c.globalAlpha=0.15,c.strokeStyle="black",c.stroke(),c.globalAlpha=r))):"square"===b?(c.beginPath(),c.rect(a-e/2,d-e/2,e,e),g&&c.fill(),n&&(h?c.stroke():(r=c.globalAlpha,c.globalAlpha=0.15,c.strokeStyle="black",c.stroke(),c.globalAlpha=r))):"triangle"===b?(c.beginPath(),c.moveTo(a-e/2,d+e/2),c.lineTo(a+e/2,d+e/2),c.lineTo(a,d-e/2),c.closePath(),g&&c.fill(),n&&(h?c.stroke():(r=c.globalAlpha,c.globalAlpha=0.15,c.strokeStyle="black",c.stroke(),c.globalAlpha=r)),c.beginPath()):
"cross"===b&&(c.strokeStyle=g,c.lineWidth=e/4,c.beginPath(),c.moveTo(a-e/2,d-e/2),c.lineTo(a+e/2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];W.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return n}();B.version="v3.7.22 GA";window.CanvasJS&&(B&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=B)})();
